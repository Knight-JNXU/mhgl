...
function buff3060Active(buff, Char, Other, Type) 
		...
		if ((Other:GetAction() == LuaI.BATCMD_SKILL or Other:GetAction() == LuaI.BATCMD_CRIT_SKILL) and
			...
			if reDam1 > 0 then
				...
				if (Char:IsBuffExist(1115) or Char:IsBuffExist(1116)) and not Char:IsBuffExist(1409) then
					reDam1 = reDam1 * (0.9 + sectrate);
				elseif Char:IsBuffExist(1409) then
					reDam1 = reDam1 * (0.875 + sectrate);
				else	
					reDam1 = reDam1 * (0.8 + sectrate);
				end				
			...
			if reDam2 > 0 then
				Char:ResetSP();
				if (Char:IsBuffExist(1115) or Char:IsBuffExist(1116)) and not Char:IsBuffExist(1409) then
					reDam2 = reDam2 * (0.9 + sectrate);
				elseif Char:IsBuffExist(1409) then
					reDam2 = reDam2 * (0.875 + sectrate);
				else	
					reDam2 = reDam2 * (0.8 + sectrate);
				end		
			...
			if reDam3 > 0 then
				Char:ResetMHP();
				if (Char:IsBuffExist(1115) or Char:IsBuffExist(1116)) and not Char:IsBuffExist(1409) then
					reDam3 = reDam3 * (0.9 + sectrate);
				elseif Char:IsBuffExist(1409) then
					reDam3 = reDam3 * (0.875 + sectrate);
				else	
					reDam3 = reDam3 * (0.8 + sectrate);
				end		
