...
function buff3074Active(buff, Char, Other, Type) 
		...
		if (Other:GetAction() == LuaI.BATCMD_ATTACK or Other:GetAction() == LuaI.BATCMD_CRIT_ATTACK or
			...
			if reDam1 > 0 then
				...
				elseif Char:IsBuffExist(1410) then
					reDam1 = reDam1 * (0.175 + sectrate);
				else	
					reDam1 = reDam1 * (0.1 + sectrate);
				end
			...
			if reDam2 > 0 then
				...
				elseif Char:IsBuffExist(1410) then
					reDam2 = reDam2 * (0.175 + sectrate);
				else	
					reDam2 = reDam2 * (0.1 + sectrate);
				end
			...
			if reDam3 > 0 then
				...
				elseif Char:IsBuffExist(1410) then
					reDam3 = reDam3 * (0.175 + sectrate);
				else	
					reDam3 = reDam3 * (0.1 + sectrate);
				end
