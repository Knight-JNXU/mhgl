...
function buff40003Repeat(buff, Char, finish)
  ...
  local Ban = 0
  if CAtk > 12000 then Ban = 1 end
  if CDef > 8000 then Ban = 1 end
  if CSpd > 3000 then Ban = 1 end
  if CPow > 10000 then Ban = 1 end
  if CHp > 50000 then Ban = 1 end
  if CMHp > 30000 then Ban = 1 end
  if CMaxHp > 50000 then Ban = 1 end
  if Ban == 1 then
  ...
  local BBan = 0
  if PAtk > 8000 then BBan = 1 end
  if PDef > 8000 then BBan = 1 end
  if PSpd > 3000 then BBan = 1 end
  if PPow > 8000 then BBan = 1 end
  if PHp > 40000 then BBan = 1 end
  if PMaxHp > 40000 then BBan = 1 end
  if BBan == 1 then
