...
Quest80002 = {							   
	...
	target_item = {{item_id = 60003, count = 1}},	
	time_mark = 800, 
}

function Quest80002:Take()	
	...
	if IsProcess() then		
		...
		player:GetItems():AddItem(60002, 1)
		guild:ChangeFund(-30000,6)		
		self.descript = "这是一张价值\#P30000\#W两的帮派商票，通过与各地商人的贸易往来，帮派希望你能让它的价值增加到\#P80000\#W两。"
  ...
  if player:GetQuests():TimeMarkOver(800, A) == false then
   ...
   --[[   guild:ChangeProsper(5)
      ShowError("帮派繁荣度增加5")--]]
			...
			RemoveQuest(self)			
			player:ChangeBusinessProfit(Profit - 30000)
			player:GetItems():RemoveAllBusinessItem()
		end
		return true
	else	
