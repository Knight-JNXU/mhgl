...
Quest80003 = {							   
	...
	target_item = {{item_id = 60005, count = 1}},	
	time_mark = 800, 
}

function Quest80003:Take()	
	...
	if IsProcess() then		
		...
		player:GetItems():AddItem(60004, 1)
		guild:ChangeFund(-40000,6)		
		self.descript = "这是一张价值\#P40000\#W两的帮派商票，通过与各地商人的贸易往来，帮派希望你能让它的价值增加到\#P160000\#W两。"
