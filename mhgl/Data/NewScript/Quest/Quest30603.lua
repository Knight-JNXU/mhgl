...
Quest30603 = {
	...
	time_mark = 306,                          -- 时间标志  
	encount_npc = { npc_id = 300287, map_id = 0, step = math.random(300,500), count = -1 },
...
function Quest30603:Return()
	...
	script:SetSaying(true)
		...
		--player:ChangeMoney(money*0.7,306)
