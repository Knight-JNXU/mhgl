...
Quest69206.Take = function(self)
  ...
  if player:GetQuests():HasQuest(69206) then
...
Quest69206.Return = function(self, character, partnerAlive)
  if IsProcess() then
    ...
    local Money = math.random(10000, 30000)
    local Honor = math.random(1,10)
  ...
  --  ShowError(string.format("#W获得经验值%d", Exp))
    player:GetQuests():RemoveQuest(69206)
    ShowError(string.format("#W获得%d威望", Honor))
