...
Bat000523 = {npc_id = 523,name = GetNpcName(523),addMob = true,BossDead = false,kill = false,weizhi = 0,catch = false,r = math.random(1,16)}
function Bat000523:OnInit()
...
function Bat000523:OnPreTurn(turn)
  battle:DisableCmd(LuaI.BATCMD_HELP)
...
function Bat000523:OnPostTurn(turn)
end
			  
			  
function Bat000523:OnFinish(turn, result)
...
-- 必需在脚本最後将战斗表加入系统中
function Bat000523:OnEscape(turn, actor)
end

AddBattleTable(Bat000523)
