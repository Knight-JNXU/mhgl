...
--[[	battle:DisableCmd(LuaI.BATCMD_HELP)
	...
	battle:AddMob(2001, 1, 145)
	battle:AddMob(2001, 1, 145)
	battle:AddMob(2001, 1, 145)	
	battle:AddMob(2002, 1, 145)	
	battle:AddMob(2002, 1, 145)	
	battle:AddMob(2002, 1, 145)	
	battle:AddMob(2005, 1, 145)	
	battle:AddMob(2005, 1, 145)	
	battle:AddMob(2006, 1, 145)	
end
...
function Bat200001:OnFinish(turn,result)
	...
	for i = 0, battle:GetCharacterCount() - 1 do
		...
		if owner then
          ...
          script:Rumor(string.format("#A%s#P打败了小BOSS，使其交出手里的#Y[%s]#P跪地求饶！", owner:GetName(), name), false)
        end
      end
    end
  end
