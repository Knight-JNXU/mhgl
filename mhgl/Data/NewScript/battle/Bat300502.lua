...
Bat300502 = {npc_id = 300502,name = GetNpcName(300502),addMob = true,BossDead = false,kill = false,weizhi = 0,catch = false,r = math.random(1,16)}
function Bat300502:OnInit()
...
function Bat300502:OnPreTurn(turn)
  battle:DisableCmd(LuaI.BATCMD_HELP)
...
function Bat300502:OnPostTurn(turn)
end
			  
			  
function Bat300502:OnFinish(turn, result)
...
-- 必需在脚本最後将战斗表加入系统中
function Bat300502:OnEscape(turn, actor)
end

AddBattleTable(Bat300502)
