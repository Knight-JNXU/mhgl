...
Bat000528 = {npc_id = 528,name = GetNpcName(528),addMob = true,BossDead = false,kill = false,weizhi = 0,catch = false,r = math.random(1,16)}
function Bat000528:OnInit()
...
function Bat000528:OnPreTurn(turn)
  battle:DisableCmd(LuaI.BATCMD_HELP)
...
function Bat000528:OnPostTurn(turn)
end
			  
			  
function Bat000528:OnFinish(turn, result)
...
-- 必需在脚本最後将战斗表加入系统中
function Bat000528:OnEscape(turn, actor)
end

AddBattleTable(Bat000528)
