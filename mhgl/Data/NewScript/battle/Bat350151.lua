...
Bat000350151 = {npc_id = 350151,name = GetNpcName(350151),addMob = true,BossDead = false,kill = false,weizhi = 0,catch = false,r = math.random(1,16)}
function Bat000350151:OnInit()
...
function Bat000350151:OnPreTurn(turn)
  battle:DisableCmd(LuaI.BATCMD_HELP)
...
function Bat000350151:OnPostTurn(turn)
end
			  
			  
function Bat000350151:OnFinish(turn, result)
...
-- 必需在脚本最後将战斗表加入系统中
function Bat000350151:OnEscape(turn, actor)
end

AddBattleTable(Bat000350151)
