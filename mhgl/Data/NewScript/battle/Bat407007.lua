...
Bat700046.OnInit = function(l_1_0)
  ...
  battle:AddMob(1416,1,base_lv)	
  battle:AddMob(1417,2,base_lv)
  battle:AddMob(1417,3,base_lv)
  battle:AddMob(1417,4,base_lv)  
  battle:AddMob(1418,5,base_lv) 
  battle:AddMob(1418,6,base_lv)
  battle:AddMob(1418,7,base_lv)
  battle:AddMob(1418,8,base_lv)
   battle:AddMob(1418,9,base_lv) 
end
