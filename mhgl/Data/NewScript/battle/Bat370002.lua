...
Bat000370002 = {npc_id = 370002,name = GetNpcName(370002),addMob = true,BossDead = false,kill = false,weizhi = 0,catch = false,r = math.random(1,16)}
function Bat000370002:OnInit()
...
function Bat000370002:OnPreTurn(turn)
  battle:DisableCmd(LuaI.BATCMD_HELP)
...
function Bat000370002:OnPostTurn(turn)
end
			  
			  
function Bat000370002:OnFinish(turn, result)
...
-- 必需在脚本最後将战斗表加入系统中
function Bat000370002:OnEscape(turn, actor)
end

AddBattleTable(Bat000370002)
