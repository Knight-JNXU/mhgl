...
--[[	battle:DisableCmd(LuaI.BATCMD_HELP)
	...
	battle:AddMob(2015, 1, 130)
	battle:AddMob(2020, 1, 130)
	battle:AddMob(2016, 1, 130)		
	battle:AddMob(4003, 1, 130)
	battle:AddMob(2023, 1, 130)
	battle:AddMob(2023, 1, 130)
    battle:AddMob(2024, 1, 130)	
    battle:AddMob(2025, 1, 130)	
end
