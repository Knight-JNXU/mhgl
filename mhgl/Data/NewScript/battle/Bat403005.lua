...
Bat700046.OnInit = function(l_1_0)
  battle:AddMob(1313, 2,129)
  battle:AddMob(958, 3,129)
  battle:AddMob(959, 4,129)
  battle:AddMob(265, 5,139)  
  battle:AddMob(983, 6,139)   
   battle:AddMob(985, 7,149) 
   battle:AddMob(980, 8,149) 
  battle:AddMob(996, 9,149) 
   battle:AddMob(1314, 1,149)  
end
    ...
    if actor then
      ...
      if owner and not actor:IsDead() then
        ...
        if freeSlot > 1 then
          ...
          if SecondP <= 10 then
local ItemList = {61026,61027,61028,61029,61030,61031,61032,61033,15000}
