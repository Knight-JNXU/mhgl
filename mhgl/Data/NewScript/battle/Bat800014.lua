...
Bat800014 = {npc_id = 800014,name = GetNpcName(800014),addMob = true,BossDead = false,kill = false,weizhi = 0,catch = false,r = math.random(1,16)}
function Bat800014:OnInit()
...
function Bat800014:OnPreTurn(turn)
  battle:DisableCmd(LuaI.BATCMD_HELP)
...
function Bat800014:OnPostTurn(turn)
end
			  
			  
function Bat800014:OnFinish(turn, result)
...
-- 必需在脚本最後将战斗表加入系统中
function Bat800014:OnEscape(turn, actor)
end

AddBattleTable(Bat800014)
