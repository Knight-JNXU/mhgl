...
--[[	battle:DisableCmd(LuaI.BATCMD_HELP)
	...
	battle:AddMob(4001, 1,150)
	battle:AddMob(4001, 1,150)
	battle:AddMob(4001, 1,150)	
	battle:AddMob(4000, 1,150)	
	battle:AddMob(4000, 1,150)	
	battle:AddMob(4000, 1,150)	
	battle:AddMob(4002, 1,150)	
	battle:AddMob(4002, 1,150)	
...
function Bat200001:OnFinish(turn,result)
	...
	for i = 0, battle:GetCharacterCount() - 1 do
		...
		if owner then
          ...
          if i <= 10 then
          item = RandTable({51392,51393,51394,51395,51396})
          ...
          script:Rumor(string.format("#A%s#P打败了上位神，使其交出手里的#Y[%s]#P跪地求饶！", owner:GetName(), name), false)
        end
      end
    end
  end
