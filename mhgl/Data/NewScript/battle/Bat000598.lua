...
--598
Bat000598 = {addMob = true,kill = false,weizhi = 0,catch = false,r = math.random(1, 3)
}

-- 战斗开始之前
function Bat000598:OnInit()
...
-- 回合开始之前
-- turn : 第几回合，从 1 开始
function Bat000598:OnPreTurn(turn)
	-- 在第一回合开始的时候
...
-- 回合结束以后
-- turn : 第几回合，从 1 开始
function Bat000598:OnPostTurn(turn)
...
-- turn : 结束回合
function Bat000598:OnFinish(turn, result)
