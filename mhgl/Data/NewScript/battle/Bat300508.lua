...
Bat300508 = {npc_id = 300508,name = GetNpcName(300508),addMob = true,BossDead = false,kill = false,weizhi = 0,catch = false,r = math.random(1,16)}
function Bat300508:OnInit()
...
function Bat300508:OnPreTurn(turn)
  battle:DisableCmd(LuaI.BATCMD_HELP)
...
function Bat300508:OnPostTurn(turn)
end
			  
			  
function Bat300508:OnFinish(turn, result)
...
-- 必需在脚本最後将战斗表加入系统中
function Bat300508:OnEscape(turn, actor)
end

AddBattleTable(Bat300508)
