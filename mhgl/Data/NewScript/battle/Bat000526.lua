...
Bat000526 = {npc_id = 526,name = GetNpcName(526),addMob = true,BossDead = false,kill = false,weizhi = 0,catch = false,r = math.random(1,16)}
function Bat000526:OnInit()
...
function Bat000526:OnPreTurn(turn)
  battle:DisableCmd(LuaI.BATCMD_HELP)
...
function Bat000526:OnPostTurn(turn)
end
			  
			  
function Bat000526:OnFinish(turn, result)
...
-- 必需在脚本最後将战斗表加入系统中
function Bat000526:OnEscape(turn, actor)
end

AddBattleTable(Bat000526)
