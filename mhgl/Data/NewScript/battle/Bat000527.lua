...
Bat000527 = {npc_id = 527,name = GetNpcName(527),addMob = true,BossDead = false,kill = false,weizhi = 0,catch = false,r = math.random(1,16)}
function Bat000527:OnInit()
...
function Bat000527:OnPreTurn(turn)
  battle:DisableCmd(LuaI.BATCMD_HELP)
...
function Bat000527:OnPostTurn(turn)
end
			  
			  
function Bat000527:OnFinish(turn, result)
...
-- 必需在脚本最後将战斗表加入系统中
function Bat000527:OnEscape(turn, actor)
end

AddBattleTable(Bat000527)
