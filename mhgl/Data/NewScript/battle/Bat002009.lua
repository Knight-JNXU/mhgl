...
--[[	battle:DisableCmd(LuaI.BATCMD_HELP)
	...
	battle:AddMob(2015, 1, 140)
	battle:AddMob(2016, 1, 140)	
	battle:AddMob(2018, 1, 140)	
	battle:AddMob(2019, 1, 140)	
	battle:AddMob(2020, 1, 140)			
	battle:AddMob(2023, 1, 140)	
	battle:AddMob(2024, 10, 140)	
	battle:AddMob(2025, 11, 140)	
	battle:AddMob(2021, 12, 140)
    battle:AddMob(4003, 13, 120)		
end
