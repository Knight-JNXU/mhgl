...
Bat0002200 = {npc_id = 2200,name = GetNpcName(2200),addMob = true,BossDead = false,kill = false,weizhi = 0,catch = false,r = math.random(1,16)}
function Bat0002200:OnInit()
...
function Bat0002200:OnPreTurn(turn)
  battle:DisableCmd(LuaI.BATCMD_HELP)
...
function Bat0002200:OnPostTurn(turn)
end
			  
			  
function Bat0002200:OnFinish(turn, result)
...
-- 必需在脚本最後将战斗表加入系统中
function Bat0002200:OnEscape(turn, actor)
end

AddBattleTable(Bat0002200)
