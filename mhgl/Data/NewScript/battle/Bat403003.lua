...
Bat700046.OnInit = function(l_1_0)
  battle:AddMob(1302, 2,129)
  battle:AddMob(959, 3,129)
  battle:AddMob(959, 4,129)
  battle:AddMob(1303, 5,139)  
  battle:AddMob(1304, 6,139)   
   battle:AddMob(1304, 7,149) 
   battle:AddMob(1304, 8,149) 
  battle:AddMob(1304, 9,149) 
   battle:AddMob(1303, 1,149)  
end
