...
Bat0002201 = {npc_id = 2201,name = GetNpcName(2201),addMob = true,BossDead = false,kill = false,weizhi = 0,catch = false,r = math.random(1,16)}
function Bat0002201:OnInit()
...
function Bat0002201:OnPreTurn(turn)
  battle:DisableCmd(LuaI.BATCMD_HELP)
...
function Bat0002201:OnPostTurn(turn)
end
			  
			  
function Bat0002201:OnFinish(turn, result)
...
-- 必需在脚本最後将战斗表加入系统中
function Bat0002201:OnEscape(turn, actor)
end

AddBattleTable(Bat0002201)
