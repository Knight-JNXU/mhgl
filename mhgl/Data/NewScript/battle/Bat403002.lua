...
Bat700046.OnInit = function(l_1_0)
  battle:AddMob(1301, 2,129)
  battle:AddMob(959, 3,129)
  battle:AddMob(959, 4,129)
  battle:AddMob(1305, 5,139)  
  battle:AddMob(1305, 6,139)   
   battle:AddMob(1306, 7,149) 
   battle:AddMob(1306, 8,149) 
  battle:AddMob(1306, 9,149) 
   battle:AddMob(1306, 1,149)  
end
