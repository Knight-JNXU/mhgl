...
Bat000524 = {npc_id = 524,name = GetNpcName(524),addMob = true,BossDead = false,kill = false,weizhi = 0,catch = false,r = math.random(1,16)}
function Bat000524:OnInit()
...
function Bat000524:OnPreTurn(turn)
  battle:DisableCmd(LuaI.BATCMD_HELP)
...
function Bat000524:OnPostTurn(turn)
end
			  
			  
function Bat000524:OnFinish(turn, result)
...
-- 必需在脚本最後将战斗表加入系统中
function Bat000524:OnEscape(turn, actor)
end

AddBattleTable(Bat000524)
