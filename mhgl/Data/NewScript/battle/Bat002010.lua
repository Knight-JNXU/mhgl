...
--[[	battle:DisableCmd(LuaI.BATCMD_HELP)
	...
	for i = 0, actorCount - 1 do
		...
		battle:AddMob(2015, 1, 150)
	battle:AddMob(2016, 1, 150)	
	battle:AddMob(2018, 1, 150)	
	battle:AddMob(2019, 1, 150)	
	battle:AddMob(2020, 1, 150)			
	battle:AddMob(2023, 1, 150)	
	battle:AddMob(2024, 10, 150)	
	battle:AddMob(2025, 11, 150)	
	battle:AddMob(2021, 12, 150)
    battle:AddMob(4003, 13, 130)		
end
...
function Bat200001:OnFinish(turn,result)
	...
	for i = 0, battle:GetCharacterCount() - 1 do
		...
		if owner then
          ...
          if i <= 50 then
          item = RandTable({ 58002,600015})
				  name = GetItemName(item)
				  owner:GetItems():AddItem(item, 2)
