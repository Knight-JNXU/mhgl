...
Bat800015 = {npc_id = 800015,name = GetNpcName(800015),addMob = true,BossDead = false,kill = false,weizhi = 0,catch = false,r = math.random(1,16)}
function Bat800015:OnInit()
...
function Bat800015:OnPreTurn(turn)
  battle:DisableCmd(LuaI.BATCMD_HELP)
...
function Bat800015:OnPostTurn(turn)
end
			  
			  
function Bat800015:OnFinish(turn, result)
...
-- 必需在脚本最後将战斗表加入系统中
function Bat800015:OnEscape(turn, actor)
end

AddBattleTable(Bat800015)
