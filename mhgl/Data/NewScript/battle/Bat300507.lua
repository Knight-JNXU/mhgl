...
Bat300507 = {npc_id = 300507,name = GetNpcName(300507),addMob = true,BossDead = false,kill = false,weizhi = 0,catch = false,r = math.random(1,16)}
function Bat300507:OnInit()
...
function Bat300507:OnPreTurn(turn)
  battle:DisableCmd(LuaI.BATCMD_HELP)
...
function Bat300507:OnPostTurn(turn)
end
			  
			  
function Bat300507:OnFinish(turn, result)
...
-- 必需在脚本最後将战斗表加入系统中
function Bat300507:OnEscape(turn, actor)
end

AddBattleTable(Bat300507)
