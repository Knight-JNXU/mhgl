...
Bat000525 = {npc_id = 525,name = GetNpcName(525),addMob = true,BossDead = false,kill = false,weizhi = 0,catch = false,r = math.random(1,16)}
function Bat000525:OnInit()
...
function Bat000525:OnPreTurn(turn)
  battle:DisableCmd(LuaI.BATCMD_HELP)
...
function Bat000525:OnPostTurn(turn)
end
			  
			  
function Bat000525:OnFinish(turn, result)
...
-- 必需在脚本最後将战斗表加入系统中
function Bat000525:OnEscape(turn, actor)
end

AddBattleTable(Bat000525)
