...
Bat000350152 = {npc_id = 350152,name = GetNpcName(350152),addMob = true,BossDead = false,kill = false,weizhi = 0,catch = false,r = math.random(1,16)}
function Bat000350152:OnInit()
...
function Bat000350152:OnPreTurn(turn)
  battle:DisableCmd(LuaI.BATCMD_HELP)
...
function Bat000350152:OnPostTurn(turn)
end
			  
			  
function Bat000350152:OnFinish(turn, result)
...
-- 必需在脚本最後将战斗表加入系统中
function Bat000350152:OnEscape(turn, actor)
end

AddBattleTable(Bat000350152)
