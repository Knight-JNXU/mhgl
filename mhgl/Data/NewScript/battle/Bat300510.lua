...
Bat300510 = {npc_id = 300510,name = GetNpcName(300510),addMob = true,BossDead = false,kill = false,weizhi = 0,catch = false,r = math.random(1,16)}
function Bat300510:OnInit()
...
function Bat300510:OnPreTurn(turn)
  battle:DisableCmd(LuaI.BATCMD_HELP)
...
function Bat300510:OnPostTurn(turn)
end
			  
			  
function Bat300510:OnFinish(turn, result)
...
-- 必需在脚本最後将战斗表加入系统中
function Bat300510:OnEscape(turn, actor)
end

AddBattleTable(Bat300510)
