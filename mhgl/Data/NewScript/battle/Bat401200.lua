...
Bat401200 = {addMob = true,kill = false,weizhi = 0,catch = false,r = math.random(1, 3)
}

-- 战斗开始之前
function Bat401200:OnInit()
  local MobId = {1143,1144,1145,420,268,254,272,945,956,957,958,959,980,981,982,983}
  local i = 1
...
-- 回合开始之前
-- turn : 第几回合，从 1 开始
function Bat401200:OnPreTurn(turn)
	-- 在第一回合开始的时候
...
-- 回合结束以后
-- turn : 第几回合，从 1 开始
function Bat401200:OnPostTurn(turn)
...
-- turn : 结束回合
function Bat401200:OnFinish(turn, result)
