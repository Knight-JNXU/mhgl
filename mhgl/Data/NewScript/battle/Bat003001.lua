...
--[[	battle:DisableCmd(LuaI.BATCMD_HELP)
	...
	battle:AddMob(3001, 1, 110)
	battle:AddMob(3002, 1, 110)
	battle:AddMob(3003, 1, 110)	
	battle:AddMob(3001, 1, 110)	
	battle:AddMob(3000, 1, 110)	
	battle:AddMob(4001, 1, 110)	
	battle:AddMob(4002, 1, 110)	
	battle:AddMob(4003, 1, 110)	
	battle:AddMob(4000, 1, 110)		
end
...
function Bat200001:OnFinish(turn,result)
	...
	for i = 0, battle:GetCharacterCount() - 1 do
		...
		if owner then
          ...
          script:Rumor(string.format("#A%s#P抓住青龙刚要张嘴吃掉，吓的青龙赶紧交出手里的#Y[%s]#P跪地求饶！", owner:GetName(), name), false)
        end
      end
    end
  end
