...
-- 回合结束以后
-- turn : 第几回合，从 1 开始
function Bat401102:OnPostTurn(turn)
end

-- 战斗结束之后
-- result : 玩家战斗结果, LuaI.END_WIN=玩家胜利，LuaI.END_LOSE=玩家战败，LuaI.END_DRAW=战斗平手
-- turn : 结束回合
function Bat401102:OnFinish(turn, result)
