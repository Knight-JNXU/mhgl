...
Bat200239.OnInit = function(l_1_0)
  battle:AddMob(963, 1, 100)
  battle:AddMob(964, 2, 100)
  battle:AddMob(983, 3, 100)
  battle:AddMob(960, 4, 100)
  battle:AddMob(961, 5, 100)
  battle:AddMob(962, 6, 100)
  battle:AddMob(984, 7, 100)  
end
...
Bat200239.OnFinish = function(l_4_0, l_4_1, l_4_2)
  for i = 0, battle:GetCharacterCount() - 1 do
    ...
    if r == 5 then
      script:Rumor(string.format("#Y%s %s %s %s %s#O不负使命，奋勇杀敌。助我#P朝廷#O击退“#A反贼首领#O”。#R皇帝#O给与丰厚的奖赏！", battle:GetCharacter(0):GetOwner():GetName(), battle:GetCharacter(1):GetOwner():GetName(), battle:GetCharacter(2):GetOwner():GetName(), battle:GetCharacter(3):GetOwner():GetName(), battle:GetCharacter(4):GetOwner():GetName()), false)
    elseif r == 4 then
      script:Rumor(string.format("#Y%s %s %s %s#O不负使命，奋勇杀敌。助我#P朝廷#O击退“#A反贼首领#O”。#R皇帝#O给与丰厚的奖赏！", battle:GetCharacter(0):GetOwner():GetName(), battle:GetCharacter(1):GetOwner():GetName(), battle:GetCharacter(2):GetOwner():GetName(), battle:GetCharacter(3):GetOwner():GetName()), false)
    elseif r == 3 then
      script:Rumor(string.format("#Y%s %s %s#O不负使命，奋勇杀敌。助我#P朝廷#O击退“#A反贼首领#O”。#R皇帝#O给与丰厚的奖赏！", battle:GetCharacter(0):GetOwner():GetName(), battle:GetCharacter(1):GetOwner():GetName(), battle:GetCharacter(2):GetOwner():GetName()), false)
    elseif r == 2 then
      script:Rumor(string.format("#Y%s %s#O不负使命，奋勇杀敌。助我#P朝廷#O击退“#A反贼首领#O”。#R皇帝#O给与丰厚的奖赏！", battle:GetCharacter(0):GetOwner():GetName(), battle:GetCharacter(1):GetOwner():GetName()), false)
    elseif r == 1 then
      script:Rumor(string.format("#Y%s#O不负使命，奋勇杀敌。助我#O朝廷#O击退“#R反贼首领#O”。#R皇帝#O给与丰厚的奖赏！", battle:GetCharacter(0):GetOwner():GetName()), false)
      end
	  end
	end
  end
