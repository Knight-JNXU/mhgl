...
--[[	battle:DisableCmd(LuaI.BATCMD_HELP)
	...
	battle:AddMob(4000,2,100)
	battle:AddMob(4000,3,100)
	battle:AddMob(4002,4,100)
	battle:AddMob(4002,5,100)
	battle:AddMob(4002,6,100)
	battle:AddMob(4001,7,100)
	battle:AddMob(4001,8,100)
	battle:AddMob(4003,9,100)
	battle:AddMob(431,10,100)
	battle:AddMob(431,11,100)
