...
Bat700046.OnInit = function(l_1_0)
  battle:AddMob(1307, 2,129)
  battle:AddMob(959, 3,129)
  battle:AddMob(959, 4,129)
  battle:AddMob(957, 5,139)  
  battle:AddMob(982, 6,139)   
   battle:AddMob(985, 7,149) 
   battle:AddMob(981, 8,149) 
  battle:AddMob(1313, 9,149) 
   battle:AddMob(1313, 1,149)  
end
