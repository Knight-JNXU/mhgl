...
Bat000370003 = {npc_id = 370003,name = GetNpcName(370003),addMob = true,BossDead = false,kill = false,weizhi = 0,catch = false,r = math.random(1,16)}
function Bat000370003:OnInit()
...
function Bat000370003:OnPreTurn(turn)
  battle:DisableCmd(LuaI.BATCMD_HELP)
...
function Bat000370003:OnPostTurn(turn)
end
			  
			  
function Bat000370003:OnFinish(turn, result)
...
-- 必需在脚本最後将战斗表加入系统中
function Bat000370003:OnEscape(turn, actor)
end

AddBattleTable(Bat000370003)
