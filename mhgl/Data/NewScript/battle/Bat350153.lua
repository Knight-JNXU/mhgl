...
Bat000350153 = {npc_id = 350153,name = GetNpcName(350153),addMob = true,BossDead = false,kill = false,weizhi = 0,catch = false,r = math.random(1,16)}
function Bat000350153:OnInit()
...
function Bat000350153:OnPreTurn(turn)
  battle:DisableCmd(LuaI.BATCMD_HELP)
...
function Bat000350153:OnPostTurn(turn)
end
			  
			  
function Bat000350153:OnFinish(turn, result)
...
-- 必需在脚本最後将战斗表加入系统中
function Bat000350153:OnEscape(turn, actor)
end

AddBattleTable(Bat000350153)
