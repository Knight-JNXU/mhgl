...
Bat000350087 = {npc_id = 350087,name = GetNpcName(350087),addMob = true,BossDead = false,kill = false,weizhi = 0,catch = false,r = math.random(1,16)}
function Bat000350087:OnInit()
...
function Bat000350087:OnPreTurn(turn)
  battle:DisableCmd(LuaI.BATCMD_HELP)
...
function Bat000350087:OnPostTurn(turn)
end
			  
			  
function Bat000350087:OnFinish(turn, result)
...
-- 必需在脚本最後将战斗表加入系统中
function Bat000350087:OnEscape(turn, actor)
end

AddBattleTable(Bat000350087)
