...
Bat000521 = {npc_id = 521,name = GetNpcName(521),addMob = true,BossDead = false,kill = false,weizhi = 0,catch = false,r = math.random(1,16)}
function Bat000521:OnInit()
...
function Bat000521:OnPreTurn(turn)
  battle:DisableCmd(LuaI.BATCMD_HELP)
...
function Bat000521:OnPostTurn(turn)
end
			  
			  
function Bat000521:OnFinish(turn, result)
...
-- 必需在脚本最後将战斗表加入系统中
function Bat000521:OnEscape(turn, actor)
end

AddBattleTable(Bat000521)
