...
Bat300504 = {npc_id = 300504,name = GetNpcName(300504),addMob = true,BossDead = false,kill = false,weizhi = 0,catch = false,r = math.random(1,16)}
function Bat300504:OnInit()
...
--[[	battle:AddMob(5038, 1, base_lv)
	battle:AddMob(5038, 1, base_lv)
	battle:AddMob(5038, 1, base_lv)	
	battle:AddMob(5038, 1, base_lv)	
	battle:AddMob(5039, 1, base_lv)	
	battle:AddMob(5039, 1, base_lv)	
	battle:AddMob(5039, 1, base_lv)	
	battle:AddMob(5039, 1, base_lv)	
	battle:AddMob(5039, 1, base_lv)	--]]
...
function Bat300504:OnPreTurn(turn)
  battle:DisableCmd(LuaI.BATCMD_HELP)
...
function Bat300504:OnPostTurn(turn)
end
			  
			  
function Bat300504:OnFinish(turn, result)
...
-- 必需在脚本最後将战斗表加入系统中
function Bat300504:OnEscape(turn, actor)
end

AddBattleTable(Bat300504)
