...
--[[	battle:DisableCmd(LuaI.BATCMD_HELP)
	...
	battle:AddMob(4001, 1,120)
	battle:AddMob(4001, 1,120)
	battle:AddMob(4001, 1,120)	
	battle:AddMob(4000, 1,120)	
	battle:AddMob(4000, 1,120)	
	battle:AddMob(4000, 1,120)	
	battle:AddMob(4002, 1,120)	
	battle:AddMob(4002, 1,120)	
	battle:AddMob(4003, 1,80)	
end
...
function Bat200001:OnFinish(turn,result)
	...
	for i = 0, battle:GetCharacterCount() - 1 do
		...
		if owner then
          ...
          script:Rumor(string.format("#A%s#P打败了中BOSS，使其交出手里的#Y[%s]#P跪地求饶！", owner:GetName(), name), false)
        end
      end
    end
  end
