...
Bat700046.OnInit = function(l_1_0)
  ...
  battle:AddMob(1404,2,base_lv)
  battle:AddMob(1404,3,base_lv)
  battle:AddMob(1405,4,base_lv)  
  battle:AddMob(1405,5,base_lv)   
   battle:AddMob(1405,6,base_lv)   
end
