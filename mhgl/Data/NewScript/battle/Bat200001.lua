...
Bat000200001 = {npc_id = 200001,name = GetNpcName(200001),addMob = true,BossDead = false,kill = false,weizhi = 0,catch = false,r = math.random(1,16)}
function Bat000200001:OnInit()
...
function Bat000200001:OnPreTurn(turn)
  battle:DisableCmd(LuaI.BATCMD_HELP)
...
function Bat000200001:OnPostTurn(turn)
end
			  
			  
function Bat000200001:OnFinish(turn, result)
...
-- 必需在脚本最後将战斗表加入系统中
function Bat000200001:OnEscape(turn, actor)
end

AddBattleTable(Bat000200001)
