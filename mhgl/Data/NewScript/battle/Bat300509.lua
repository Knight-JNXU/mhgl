...
Bat300509 = {npc_id = 300509,name = GetNpcName(300509),addMob = true,BossDead = false,kill = false,weizhi = 0,catch = false,r = math.random(1,16)}
function Bat300509:OnInit()
...
function Bat300509:OnPreTurn(turn)
  battle:DisableCmd(LuaI.BATCMD_HELP)
...
function Bat300509:OnPostTurn(turn)
end
			  
			  
function Bat300509:OnFinish(turn, result)
...
-- 必需在脚本最後将战斗表加入系统中
function Bat300509:OnEscape(turn, actor)
end

AddBattleTable(Bat300509)
