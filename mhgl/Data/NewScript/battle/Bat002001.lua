...
--[[	battle:DisableCmd(LuaI.BATCMD_HELP)
	...
	battle:AddMob(2015, 1, 30)
	battle:AddMob(2020, 1, 30)
	battle:AddMob(2016, 1, 30)		
	battle:AddMob(4003, 1, 1)
    battle:AddMob(2023, 1, 30)	
end
	...
	for i = 0, battle:GetCharacterCount() - 1 do
		...
		if owner then
			if result == LuaI.END_WIN and not actor:IsDead() then
				...
				Exp = math.floor(lvdiffModify *((30 * LvPlayer + 10) * 6.6 * 4) )* 2.5 * 10
