...
--[[	battle:DisableCmd(LuaI.BATCMD_HELP)
	...
	battle:AddMob(2015, 1, 190)
	battle:AddMob(2016, 1, 190)	
	battle:AddMob(2018, 1, 190)	
	battle:AddMob(2019, 1, 190)	
	battle:AddMob(2020, 1, 190)			
	battle:AddMob(2023, 1, 190)	
	battle:AddMob(2024, 10, 190)	
	battle:AddMob(2025, 11, 190)	
	battle:AddMob(2021, 12, 190)
    battle:AddMob(4003, 13, 150)		
end
