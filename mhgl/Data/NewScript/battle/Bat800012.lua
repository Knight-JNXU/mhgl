...
Bat800012 = {npc_id = 800012,name = GetNpcName(800012),addMob = true,BossDead = false,kill = false,weizhi = 0,catch = false,r = math.random(1,16)}
function Bat800012:OnInit()
...
function Bat800012:OnPreTurn(turn)
  battle:DisableCmd(LuaI.BATCMD_HELP)
...
function Bat800012:OnPostTurn(turn)
end
			  
			  
function Bat800012:OnFinish(turn, result)
...
-- 必需在脚本最後将战斗表加入系统中
function Bat800012:OnEscape(turn, actor)
end

AddBattleTable(Bat800012)
