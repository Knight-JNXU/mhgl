...
Bat300505 = {npc_id = 300505,name = GetNpcName(300505),addMob = true,BossDead = false,kill = false,weizhi = 0,catch = false,r = math.random(1,16)}

function Bat300505:OnInit()
...
--[[	battle:AddMob(5041, 1, base_lv)
	battle:AddMob(5041, 1, base_lv)
	battle:AddMob(5041, 1, base_lv)	
	battle:AddMob(5041, 1, base_lv)	
	battle:AddMob(5042, 1, base_lv)	
	battle:AddMob(5042, 1, base_lv)	
	battle:AddMob(5042, 1, base_lv)	
	battle:AddMob(5042, 1, base_lv)	
	battle:AddMob(5042, 1, base_lv)	--]]
end
function Bat300505:OnPreTurn(turn)
  battle:DisableCmd(LuaI.BATCMD_HELP)
...
function Bat300505:OnPostTurn(turn)
end
			  
			  
function Bat300505:OnFinish(turn, result)
...
-- 必需在脚本最後将战斗表加入系统中
function Bat300505:OnEscape(turn, actor)
end

AddBattleTable(Bat300505)
