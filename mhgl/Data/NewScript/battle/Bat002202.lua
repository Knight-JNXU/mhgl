...
Bat0002202 = {npc_id = 2202,name = GetNpcName(2202),addMob = true,BossDead = false,kill = false,weizhi = 0,catch = false,r = math.random(1,16)}
function Bat0002202:OnInit()
...
function Bat0002202:OnPreTurn(turn)
  battle:DisableCmd(LuaI.BATCMD_HELP)
...
function Bat0002202:OnPostTurn(turn)
end
			  
			  
function Bat0002202:OnFinish(turn, result)
...
-- 必需在脚本最後将战斗表加入系统中
function Bat0002202:OnEscape(turn, actor)
end

AddBattleTable(Bat0002202)
