...
Bat800013 = {npc_id = 800013,name = GetNpcName(800013),addMob = true,BossDead = false,kill = false,weizhi = 0,catch = false,r = math.random(1,16)}
function Bat800013:OnInit()
...
function Bat800013:OnPreTurn(turn)
  battle:DisableCmd(LuaI.BATCMD_HELP)
...
function Bat800013:OnPostTurn(turn)
end
			  
			  
function Bat800013:OnFinish(turn, result)
...
-- 必需在脚本最後将战斗表加入系统中
function Bat800013:OnEscape(turn, actor)
end

AddBattleTable(Bat800013)
