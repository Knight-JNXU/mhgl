...
Bat000002 = {}
Bat000002.OnInit = function(self)
...
Bat000002.OnPreTurn = function(self, turn)
...
Bat000002.OnPostTurn = function(self, turn)
end

Bat000002.OnFinish = function(self, turn, result)
  if result == LuaI.END_WIN then
--    Quest96001:Return(0)
  end
end

AddBattleTable(Bat000002)
