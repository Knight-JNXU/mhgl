...
Bat300506 = {npc_id = 300506,name = GetNpcName(300506),addMob = true,BossDead = false,kill = false,weizhi = 0,catch = false,r = math.random(1,16)}
function Bat300506:OnInit()
	...
	--[[battle:AddMob(5044, 1, base_lv)
	battle:AddMob(5044, 1, base_lv)
	battle:AddMob(5044, 1, base_lv)	
	battle:AddMob(5044, 1, base_lv)	
	battle:AddMob(5045, 1, base_lv)	
	battle:AddMob(5045, 1, base_lv)	
	battle:AddMob(5045, 1, base_lv)	
	battle:AddMob(5045, 1, base_lv)	
	battle:AddMob(5045, 1, base_lv)	--]]
...
function Bat300506:OnPreTurn(turn)
  battle:DisableCmd(LuaI.BATCMD_HELP)
...
function Bat300506:OnPostTurn(turn)
end
			  
			  
function Bat300506:OnFinish(turn, result)
...
-- 必需在脚本最後将战斗表加入系统中
function Bat300506:OnEscape(turn, actor)
end

AddBattleTable(Bat300506)
