...
--[[	battle:DisableCmd(LuaI.BATCMD_HELP)
	...
	battle:AddMob(4000,1,70)
	battle:AddMob(4000,2,70)
	battle:AddMob(4000,3,70)
	battle:AddMob(4002,4,70)
	battle:AddMob(4002,5,70)
	battle:AddMob(4002,6,70)
	battle:AddMob(4001,7,70)
	battle:AddMob(4001,8,70)
	battle:AddMob(4003,9,70)
	-- battle:AddMob(441,9,119)
 	--battle:GetActor(0):AddBuff(7025,1,1,0,10,100)
end
