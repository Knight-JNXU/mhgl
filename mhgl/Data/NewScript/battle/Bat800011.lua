...
Bat800011 = {npc_id = 800011,name = GetNpcName(800011),addMob = true,BossDead = false,kill = false,weizhi = 0,catch = false,r = math.random(1,16)}
function Bat800011:OnInit()
...
function Bat800011:OnPreTurn(turn)
  battle:DisableCmd(LuaI.BATCMD_HELP)
...
function Bat800011:OnPostTurn(turn)
end
			  
			  
function Bat800011:OnFinish(turn, result)
...
-- 必需在脚本最後将战斗表加入系统中
function Bat800011:OnEscape(turn, actor)
end

AddBattleTable(Bat800011)
