...
--[[	battle:DisableCmd(LuaI.BATCMD_HELP)
	...
	battle:AddMob(1150, 1, 100)
	battle:AddMob(1151, 1, 100)
	battle:AddMob(1152, 1, 100)	
	battle:AddMob(1153, 1, 100)	
	battle:AddMob(1154, 1, 100)	
	battle:AddMob(1155, 1, 100)	
	battle:AddMob(1156, 1, 100)	
	battle:AddMob(986, 1, 100)	
	battle:AddMob(986, 1, 100)	
end
...
function Bat000730:OnFinish(turn,result)
	...
	for i = 0, battle:GetCharacterCount() - 1 do
        ...
        if i <= 50 then
          item = RandTable({80683,80684,80685,80686,80687,80688})
