...
Bat000350088 = {npc_id = 350088,name = GetNpcName(350088),addMob = true,BossDead = false,kill = false,weizhi = 0,catch = false,r = math.random(1,16)}
function Bat000350088:OnInit()
...
function Bat000350088:OnPreTurn(turn)
  battle:DisableCmd(LuaI.BATCMD_HELP)
...
function Bat000350088:OnPostTurn(turn)
end
			  
			  
function Bat000350088:OnFinish(turn, result)
...
-- 必需在脚本最後将战斗表加入系统中
function Bat000350088:OnEscape(turn, actor)
end

AddBattleTable(Bat000350088)
