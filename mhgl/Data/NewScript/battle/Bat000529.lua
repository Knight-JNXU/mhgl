...
Bat000529 = {npc_id = 529,name = GetNpcName(529),addMob = true,BossDead = false,kill = false,weizhi = 0,catch = false,r = math.random(1,16)}
function Bat000529:OnInit()
...
function Bat000529:OnPreTurn(turn)
  battle:DisableCmd(LuaI.BATCMD_HELP)
...
function Bat000529:OnPostTurn(turn)
end
			  
			  
function Bat000529:OnFinish(turn, result)
...
-- 必需在脚本最後将战斗表加入系统中
function Bat000529:OnEscape(turn, actor)
end

AddBattleTable(Bat000529)
