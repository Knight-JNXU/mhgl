...
Bat000200002 = {npc_id = 200002,name = GetNpcName(200002),addMob = true,BossDead = false,kill = false,weizhi = 0,catch = false,r = math.random(1,16)}
function Bat000200002:OnInit()
...
function Bat000200002:OnPreTurn(turn)
  battle:DisableCmd(LuaI.BATCMD_HELP)
...
function Bat000200002:OnPostTurn(turn)
end
			  
			  
function Bat000200002:OnFinish(turn, result)
...
-- 必需在脚本最後将战斗表加入系统中
function Bat000200002:OnEscape(turn, actor)
end

AddBattleTable(Bat000200002)
