...
function Item60210:MapUse(target)
	if target and target:GetUserType() == 2 then --召唤兽
		...
		WaitAnswer(2)
		if GetAnswer() == 1 then				
			local NewSkillID = 285
			local NewSkillName = "土属性吸收"
...
function Item60210:CanUse(user, target)
end

function Item60210:BattleUse(user, target)

end

AddItemTable(Item60210)