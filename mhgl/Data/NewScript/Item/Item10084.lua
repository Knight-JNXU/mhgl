--author: apollo
--武学秘籍 指定同伴后右击使用：使同伴学会"飞行"招式

Item10084 = {
}

function Item10084:MapUse(target)
	if target and target:GetUserType() == 2 then --同伴
		...
		WaitAnswer(2)
		if GetAnswer() == 1 then				
			local NewSkillID = 252
			local NewSkillName = "飞行"
...
function Item10084:CanUse(user, target)
end

function Item10084:BattleUse(user, target)

end

AddItemTable(Item10084)