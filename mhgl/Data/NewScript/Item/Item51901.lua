...
-- Command line was: D:\Server\Data\NewScript\Item\Item51901.out 

Item51901 = {}
Item51901.MapUse = function(self, target)
  if target and target:GetUserType() == 2 then
    ...
    WaitAnswer(2)
    if GetAnswer() == 1 then
      local NewSkillID = 4601
      local NewSkillName = "三阳启泰式"
...
Item51901.CanUse = function(self, user, target)
end

Item51901.BattleUse = function(self, user, target)
end

AddItemTable(Item51901)
