--author: apollo
--武学秘籍 指定同伴后右击使用：使同伴学会"无双一击"招式

Item51108 = {
}

function Item51108:MapUse(target)
	if target and target:GetUserType() == 2 then --同伴
		...
		WaitAnswer(2)
		if GetAnswer() == 1 then				
			local NewSkillID = 258
			local NewSkillName = "无双一击"
...
function Item51108:CanUse(user, target)
end

function Item51108:BattleUse(user, target)

end

AddItemTable(Item51108)