--author: apollo
--武学秘籍 指定宝宝后右击使用：使宝宝学会"高级隐身"技能

Item40006 = {
}

function Item40006:MapUse(target)
...
function Item40006:CanUse(user, target)
end

function Item40006:BattleUse(user, target)

end

AddItemTable(Item40006)