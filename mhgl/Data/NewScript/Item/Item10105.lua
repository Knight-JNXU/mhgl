--author: apollo
--武学秘籍 指定同伴后右击使用：使同伴学会"精神集中"招式

Item10105 = {
}

function Item10105:MapUse(target)
	if target and target:GetUserType() == 2 then --同伴
		...
		WaitAnswer(2)
		if GetAnswer() == 1 then				
			local NewSkillID = 271
			local NewSkillName = "精神集中"
...
function Item10105:CanUse(user, target)
end

function Item10105:BattleUse(user, target)

end

AddItemTable(Item10105)