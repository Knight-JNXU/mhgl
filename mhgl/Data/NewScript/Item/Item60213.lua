...
function Item60213:MapUse(target)
	if target and target:GetUserType() == 2 then --召唤兽
		...
		WaitAnswer(2)
		if GetAnswer() == 1 then				
			local NewSkillID = 319
			local NewSkillName = "高级火属性吸收"
...
function Item60213:CanUse(user, target)
end

function Item60213:BattleUse(user, target)

end

AddItemTable(Item60213)