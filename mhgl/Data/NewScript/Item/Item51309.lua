...
function Item51309:MapUse(target)
	if target and target:GetUserType() == 1 then --人物
		local NewSkillID = 10
		local NewSkillName = "《幻剑阵》"
...
function Item51309:CanUse(user, target)
end

function Item51309:BattleUse(user, target)

end

AddItemTable(Item51309)