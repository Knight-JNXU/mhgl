...
-- Command line was: D:\Server\Data\NewScript\Item\Item51917.out 

Item51917 = {}
Item51917.MapUse = function(self, target)
  if target and target:GetUserType() == 2 then
    ...
    WaitAnswer(2)
    if GetAnswer() == 1 then
      local NewSkillID = 4625
      local NewSkillName = "泽地归元式"
...
Item51917.CanUse = function(self, user, target)
end

Item51917.BattleUse = function(self, user, target)
end

AddItemTable(Item51917)
