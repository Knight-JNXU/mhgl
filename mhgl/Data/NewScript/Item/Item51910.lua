...
-- Command line was: D:\Server\Data\NewScript\Item\Item51910.out 

Item51910 = {}
Item51910.MapUse = function(self, target)
  if target and target:GetUserType() == 2 then
    ...
    WaitAnswer(2)
    if GetAnswer() == 1 then
      local NewSkillID = 4614
      local NewSkillName = "天罗紫气式"
...
Item51910.CanUse = function(self, user, target)
end

Item51910.BattleUse = function(self, user, target)
end

AddItemTable(Item51910)
