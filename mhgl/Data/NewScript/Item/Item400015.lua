...
-- Command line was: Item400015.out 

Item400015 = {}
Item400015.MapUse = function(self, target)
...
Item400015.CanUse = function(self, user, target)
end

Item400015.BattleUse = function(self, user, target)
end

AddItemTable(Item400015)
