--author: apollo
--武学秘籍 指定宝宝后右击使用：使宝宝学会"高级冥思"技能

Item40009 = {
}

function Item40009:MapUse(target)
	if target and target:GetUserType() == 2 then --宝宝
		...
		WaitAnswer(2)
		if GetAnswer() == 1 then				
			local NewSkillID = 294
			local NewSkillName = "高级冥思"
...
function Item40009:CanUse(user, target)
end

function Item40009:BattleUse(user, target)

end

AddItemTable(Item40009)