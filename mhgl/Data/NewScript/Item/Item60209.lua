...
function Item60209:MapUse(target)
	if target and target:GetUserType() == 2 then --召唤兽
		...
		WaitAnswer(2)
		if GetAnswer() == 1 then				
			local NewSkillID = 281
			local NewSkillName = "火属性吸收"
...
function Item60209:CanUse(user, target)
end

function Item60209:BattleUse(user, target)

end

AddItemTable(Item60209)