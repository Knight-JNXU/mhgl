...
function Item60205:MapUse(target)
	if target and target:GetUserType() == 2 then --召唤兽
		...
		WaitAnswer(2)
		if GetAnswer() == 1 then				
			local NewSkillID = 314
			local NewSkillName = "水漫金山"
...
function Item60205:CanUse(user, target)
end

function Item60205:BattleUse(user, target)

end

AddItemTable(Item60205)