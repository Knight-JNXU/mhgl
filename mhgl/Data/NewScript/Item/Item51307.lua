...
function Item51307:MapUse(target)
	if target and target:GetUserType() == 1 then --人物
		local NewSkillID = 8
		local NewSkillName = "《地截阵》"
...
function Item51307:CanUse(user, target)
end

function Item51307:BattleUse(user, target)

end

AddItemTable(Item51307)