...
function Item51311:MapUse(target)
	if target and target:GetUserType() == 1 then --人物
		local NewSkillID = 12
		local NewSkillName = "《云垂阵》"
...
function Item51311:CanUse(user, target)
end

function Item51311:BattleUse(user, target)

end

AddItemTable(Item51311)