...
function Item60202:MapUse(target)
	if target and target:GetUserType() == 2 then --召唤兽
		...
		WaitAnswer(2)
		if GetAnswer() == 1 then				
			local NewSkillID = 274
			local NewSkillName = "落岩"
...
function Item60202:CanUse(user, target)
end

function Item60202:BattleUse(user, target)

end

AddItemTable(Item60202)