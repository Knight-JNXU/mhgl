...
function Item40049:MapUse(target)
	if target and target:GetUserType() == 2 then --召唤兽
		...
		WaitAnswer(2)
		if GetAnswer() == 1 then				
			local NewSkillID = 4555
			local NewSkillName = "八凶法阵"
...
function Item40049:CanUse(user, target)
end

function Item40049:BattleUse(user, target)

end

AddItemTable(Item40049)