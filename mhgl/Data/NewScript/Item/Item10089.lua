--author: apollo
--武学秘籍 指定同伴后右击使用：使同伴学会"冥思"招式

Item10089 = {
}

function Item10089:MapUse(target)
	if target and target:GetUserType() == 2 then --同伴
		...
		WaitAnswer(2)
		if GetAnswer() == 1 then				
			local NewSkillID = 256
			local NewSkillName = "冥思"
...
function Item10089:CanUse(user, target)
end

function Item10089:BattleUse(user, target)

end

AddItemTable(Item10089)