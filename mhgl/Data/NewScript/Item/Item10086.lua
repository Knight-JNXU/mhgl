--author: apollo
--武学秘籍 指定同伴后右击使用：使同伴学会"隐身"招式

Item10086 = {
}

function Item10086:MapUse(target)
	if target and target:GetUserType() == 2 then --同伴
		...
		WaitAnswer(2)
		if GetAnswer() == 1 then				
			local NewSkillID = 253
			local NewSkillName = "隐身"
...
function Item10086:CanUse(user, target)
end

function Item10086:BattleUse(user, target)

end

AddItemTable(Item10086)