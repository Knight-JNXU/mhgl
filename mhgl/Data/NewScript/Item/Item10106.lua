--author: apollo
--武学秘籍 指定同伴后右击使用：使同伴学会"否定信仰"招式

Item10106 = {
}

function Item10106:MapUse(target)
	if target and target:GetUserType() == 2 then --同伴
		...
		WaitAnswer(2)
		if GetAnswer() == 1 then				
			local NewSkillID = 272
			local NewSkillName = "否定信仰"
...
function Item10106:CanUse(user, target)
end

function Item10106:BattleUse(user, target)

end

AddItemTable(Item10106)