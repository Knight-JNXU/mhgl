...
-- Command line was: D:\Server\Data\NewScript\Item\Item51916.out 

Item51916 = {}
Item51916.MapUse = function(self, target)
  if target and target:GetUserType() == 2 then
    ...
    WaitAnswer(2)
    if GetAnswer() == 1 then
      local NewSkillID = 4624
      local NewSkillName = "长生未散式"
...
Item51916.CanUse = function(self, user, target)
end

Item51916.BattleUse = function(self, user, target)
end

AddItemTable(Item51916)
