...
-- Command line was: D:\Server\Data\NewScript\Item\Item51906.out 

Item51906 = {}
Item51906.MapUse = function(self, target)
  if target and target:GetUserType() == 2 then
    ...
    WaitAnswer(2)
    if GetAnswer() == 1 then
      local NewSkillID = 4610
      local NewSkillName = "云絮绵绵式"
...
Item51906.CanUse = function(self, user, target)
end

Item51906.BattleUse = function(self, user, target)
end

AddItemTable(Item51906)
