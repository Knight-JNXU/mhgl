--author: apollo
--武学秘籍 指定同伴后右击使用：使同伴学会"凝神聚气"招式

Item51120 = {
}

function Item51120:MapUse(target)
	if target and target:GetUserType() == 2 then --同伴
		...
		WaitAnswer(2)
		if GetAnswer() == 1 then				
			local NewSkillID = 270
			local NewSkillName = "凝神聚气"
...
function Item51120:CanUse(user, target)
end

function Item51120:BattleUse(user, target)

end

AddItemTable(Item51120)