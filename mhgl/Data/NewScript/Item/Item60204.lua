...
function Item60204:MapUse(target)
	if target and target:GetUserType() == 2 then --召唤兽
		...
		WaitAnswer(2)
		if GetAnswer() == 1 then				
			local NewSkillID = 311
			local NewSkillName = "地狱烈火"
...
function Item60204:CanUse(user, target)
end

function Item60204:BattleUse(user, target)

end

AddItemTable(Item60204)