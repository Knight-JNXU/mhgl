...
function Item60203:MapUse(target)
	if target and target:GetUserType() == 2 then --召唤兽
		...
		WaitAnswer(2)
		if GetAnswer() == 1 then				
			local NewSkillID = 275
			local NewSkillName = "雷击"
...
function Item60203:CanUse(user, target)
end

function Item60203:BattleUse(user, target)

end

AddItemTable(Item60203)