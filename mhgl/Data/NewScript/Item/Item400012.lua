...
-- Command line was: Item400012.out 

Item400012 = {}
Item400012.MapUse = function(self, target)
...
Item400012.CanUse = function(self, user, target)
end

Item400012.BattleUse = function(self, user, target)
end

AddItemTable(Item400012)
