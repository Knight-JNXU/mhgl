...
function Item60208:MapUse(target)
	if target and target:GetUserType() == 2 then --召唤兽
		...
		WaitAnswer(2)
		if GetAnswer() == 1 then				
			local NewSkillID = 284
			local NewSkillName = "水属性吸收"
...
function Item60208:CanUse(user, target)
end

function Item60208:BattleUse(user, target)

end

AddItemTable(Item60208)