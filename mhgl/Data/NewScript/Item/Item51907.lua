...
-- Command line was: D:\Server\Data\NewScript\Item\Item51907.out 

Item51907 = {}
Item51907.MapUse = function(self, target)
  if target and target:GetUserType() == 2 then
    ...
    WaitAnswer(2)
    if GetAnswer() == 1 then
      local NewSkillID = 4611
      local NewSkillName = "气游天地式"
...
Item51907.CanUse = function(self, user, target)
end

Item51907.BattleUse = function(self, user, target)
end

AddItemTable(Item51907)
