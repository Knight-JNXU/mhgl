--author: apollo
--武学秘籍 指定宝宝后右击使用：使宝宝学会"高级敏捷"技能

Item40016 = {
}

function Item40016:MapUse(target)
	if target and target:GetUserType() == 2 then --宝宝
		...
		WaitAnswer(2)
		if GetAnswer() == 1 then			
			local NewSkillID = 301
			local NewSkillName = "高级敏捷"
...
function Item40016:CanUse(user, target)
end

function Item40016:BattleUse(user, target)

end

AddItemTable(Item40016)