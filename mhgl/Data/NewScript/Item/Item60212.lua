...
function Item60212:MapUse(target)
	if target and target:GetUserType() == 2 then --召唤兽
		...
		WaitAnswer(2)
		if GetAnswer() == 1 then				
			local NewSkillID = 322
			local NewSkillName = "高级水属性吸收"
...
function Item60212:CanUse(user, target)
end

function Item60212:BattleUse(user, target)

end

AddItemTable(Item60212)