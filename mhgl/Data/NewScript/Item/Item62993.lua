...
Item61086.MapUse = function(l_1_0, l_1_1)
  ItemAsk("使用官职3倍积分，你便可以立即获得1小时的官职3倍积分时间噢！~（时间不可累加）")
  SetAnswer(1, string.format("使用“官职3倍积分”"))
  SetAnswer(2, "今天不好用")
  WaitAnswer(2)
  if GetAnswer() == 1 then
   --[[if player:HasBuff(218) then
    ...
    if player:HasBuff(303) then
      ...
      player:AddBuff(116, 0, 0, 0, 60, 100)
	   player:GetItems():RemoveItem(62993, 1)
      ShowHint("成功使用“官职3倍积分”，获得1小时官职3倍积分时间。")
    end
  end
