...
-- Command line was: Item400018.out 

Item400018 = {}
Item400018.MapUse = function(self, target)
...
Item400018.CanUse = function(self, user, target)
end

Item400018.BattleUse = function(self, user, target)
end

AddItemTable(Item400018)
