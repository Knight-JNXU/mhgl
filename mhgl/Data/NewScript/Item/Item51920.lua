...
-- Command line was: D:\Server\Data\NewScript\Item\Item51920.out 

Item51920 = {}
Item51920.MapUse = function(self, target)
  if target and target:GetUserType() == 2 then
    ...
    WaitAnswer(2)
    if GetAnswer() == 1 then
      local NewSkillID = 4640
      local NewSkillName = "迎风摆柳式"
...
Item51920.CanUse = function(self, user, target)
end

Item51920.BattleUse = function(self, user, target)
end

AddItemTable(Item51920)
