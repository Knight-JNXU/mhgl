--author: apollo
--武学秘籍 指定同伴后右击使用：使同伴学会"反震"招式

Item10081 = {
}

function Item10081:MapUse(target)
	if target and target:GetUserType() == 2 then --同伴
		...
		WaitAnswer(2)
		if GetAnswer() == 1 then						
			local NewSkillID = 249
			local NewSkillName = "反震"
...
function Item10081:CanUse(user, target)
end

function Item10081:BattleUse(user, target)

end

AddItemTable(Item10081)