--author: apollo
--武学秘籍 指定宝宝后右击使用：使宝宝学会"高级法术暴击"技能

Item40028 = {
}

function Item40028:MapUse(target)
	if target and target:GetUserType() == 2 then --宝宝
		...
		WaitAnswer(2)
		if GetAnswer() == 1 then			
			local NewSkillID = 317
			local NewSkillName = "高级法术暴击"
...
function Item40028:CanUse(user, target)
end

function Item40028:BattleUse(user, target)

end

AddItemTable(Item40028)