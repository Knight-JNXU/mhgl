...
-- Command line was: D:\Server\Data\NewScript\Item\Item51915.out 

Item51915 = {}
Item51915.MapUse = function(self, target)
  if target and target:GetUserType() == 2 then
    ...
    WaitAnswer(2)
    if GetAnswer() == 1 then
      local NewSkillID = 4623
      local NewSkillName = "天韵灵心式"
...
Item51915.CanUse = function(self, user, target)
end

Item51915.BattleUse = function(self, user, target)
end

AddItemTable(Item51915)
