--author: apollo
--武学秘籍 指定宝宝后右击使用：使宝宝学会"高级再生"技能

Item40008 = {
}

function Item40008:MapUse(target)
	if target and target:GetUserType() == 2 then --宝宝
		...
		WaitAnswer(2)
		if GetAnswer() == 1 then				
			local NewSkillID = 293
			local NewSkillName = "高级再生"
...
function Item40008:CanUse(user, target)
end

function Item40008:BattleUse(user, target)

end

AddItemTable(Item40008)