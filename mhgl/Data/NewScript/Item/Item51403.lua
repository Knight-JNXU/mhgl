  ...
  WaitAnswer(23)
    if GetAnswer() == 1 then
	  ...
	  WaitAnswer(20)
	   ...
	   player:ChangeSkillLv(376,29)
	   player:ChangeSkillLv(377,29)
	   player:ChangeSkillLv(378,29)
	   player:ChangeSkillLv(379,29)
	   player:ChangeSkillLv(382,29)
	   player:ChangeSkillLv(383,29)
	   player:ChangeSkillLv(384,29)
	   player:ChangeSkillLv(385,29)
       NpcSay("恭喜！你现在已经是8项修为30级的高手了！")
	 end
