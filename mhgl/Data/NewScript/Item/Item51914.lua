...
-- Command line was: D:\Server\Data\NewScript\Item\Item51914.out 

Item51914 = {}
Item51914.MapUse = function(self, target)
  if target and target:GetUserType() == 2 then
    ...
    WaitAnswer(2)
    if GetAnswer() == 1 then
      local NewSkillID = 4622
      local NewSkillName = "妙法有源式"
...
Item51914.CanUse = function(self, user, target)
end

Item51914.BattleUse = function(self, user, target)
end

AddItemTable(Item51914)
