--author: apollo
--武学秘籍 指定同伴后右击使用：使同伴学会"幸运"招式

Item10092 = {
}

function Item10092:MapUse(target)
	if target and target:GetUserType() == 2 then --同伴
		...
		WaitAnswer(2)
		if GetAnswer() == 1 then				
			local NewSkillID = 259
			local NewSkillName = "幸运"
...
function Item10092:CanUse(user, target)
end

function Item10092:BattleUse(user, target)

end

AddItemTable(Item10092)