--author: apollo
--武学秘籍 指定宝宝后右击使用：使宝宝学会"高级鬼魂术"技能

Item40022 = {
}

function Item40022:MapUse(target)
	if target and target:GetUserType() == 2 then --宝宝
		...
		WaitAnswer(2)
		if GetAnswer() == 1 then			
			local NewSkillID = 306
			local NewSkillName = "高级鬼魂术"
...
function Item40022:CanUse(user, target)
end

function Item40022:BattleUse(user, target)

end

AddItemTable(Item40022)