--author: apollo
--武学秘籍 指定同伴后右击使用：使同伴学会"敏捷"招式

Item10096 = {
}

function Item10096:MapUse(target)
	if target and target:GetUserType() == 2 then --同伴
		...
		WaitAnswer(2)
		if GetAnswer() == 1 then				
			local NewSkillID = 263
			local NewSkillName = "敏捷"
...
function Item10096:CanUse(user, target)
end

function Item10096:BattleUse(user, target)

end

AddItemTable(Item10096)