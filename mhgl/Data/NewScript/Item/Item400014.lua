...
-- Command line was: Item400014.out 

Item400014 = {}
Item400014.MapUse = function(self, target)
...
Item400014.CanUse = function(self, user, target)
end

Item400014.BattleUse = function(self, user, target)
end

AddItemTable(Item400014)
