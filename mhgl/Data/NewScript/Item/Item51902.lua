...
-- Command line was: D:\Server\Data\NewScript\Item\Item51902.out 

Item51902 = {}
Item51902.MapUse = function(self, target)
  if target and target:GetUserType() == 2 then
    ...
    WaitAnswer(2)
    if GetAnswer() == 1 then
      local NewSkillID = 4602
      local NewSkillName = "大日虚空式"
...
Item51902.CanUse = function(self, user, target)
end

Item51902.BattleUse = function(self, user, target)
end

AddItemTable(Item51902)
