...
-- Command line was: D:\Server\Data\NewScript\Item\Item51913.out 

Item51913 = {}
Item51913.MapUse = function(self, target)
  if target and target:GetUserType() == 2 then
    ...
    WaitAnswer(2)
    if GetAnswer() == 1 then
      local NewSkillID = 4621
      local NewSkillName = "神行守正式"
...
Item51913.CanUse = function(self, user, target)
end

Item51913.BattleUse = function(self, user, target)
end

AddItemTable(Item51913)
