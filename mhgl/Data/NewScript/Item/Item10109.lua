--author: apollo
--武学秘籍 指定同伴后右击使用：使同伴学会"法术波动"招式

Item10109 = {
}

function Item10109:MapUse(target)
	if target and target:GetUserType() == 2 then --同伴
		...
		WaitAnswer(2)
		if GetAnswer() == 1 then				
			local NewSkillID = 280
			local NewSkillName = "法术波动"
...
function Item10109:CanUse(user, target)
end

function Item10109:BattleUse(user, target)

end

AddItemTable(Item10109)