...
-- Command line was: D:\Server\Data\NewScript\Item\Item51908.out 

Item51908 = {}
Item51908.MapUse = function(self, target)
  if target and target:GetUserType() == 2 then
    ...
    WaitAnswer(2)
    if GetAnswer() == 1 then
      local NewSkillID = 4612
      local NewSkillName = "一念圆融式"
...
Item51908.CanUse = function(self, user, target)
end

Item51908.BattleUse = function(self, user, target)
end

AddItemTable(Item51908)
