...
-- Command line was: D:\Server\Data\NewScript\Item\Item51919.out 

Item51919 = {}
Item51919.MapUse = function(self, target)
  if target and target:GetUserType() == 2 then
    ...
    WaitAnswer(2)
    if GetAnswer() == 1 then
      local NewSkillID = 4631
      local NewSkillName = "罗汉卸劲式"
...
Item51919.CanUse = function(self, user, target)
end

Item51919.BattleUse = function(self, user, target)
end

AddItemTable(Item51919)
