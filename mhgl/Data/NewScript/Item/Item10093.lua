--author: apollo
--武学秘籍 指定同伴后右击使用：使同伴学会"神迹"招式

Item10093 = {
}

function Item10093:MapUse(target)
	if target and target:GetUserType() == 2 then --同伴
		...
		WaitAnswer(2)
		if GetAnswer() == 1 then				
			local NewSkillID = 260
			local NewSkillName = "神迹"
...
function Item10093:CanUse(user, target)
end

function Item10093:BattleUse(user, target)

end

AddItemTable(Item10093)