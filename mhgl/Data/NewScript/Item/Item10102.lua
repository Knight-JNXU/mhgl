--author: apollo
--武学秘籍 指定同伴后右击使用：使同伴学会"鬼魂术"招式

Item10102 = {
}

function Item10102:MapUse(target)
	if target and target:GetUserType() == 2 then --同伴
		...
		WaitAnswer(2)
		if GetAnswer() == 1 then				
			local NewSkillID = 268
			local NewSkillName = "鬼魂术"
...
function Item10102:CanUse(user, target)
end

function Item10102:BattleUse(user, target)

end

AddItemTable(Item10102)