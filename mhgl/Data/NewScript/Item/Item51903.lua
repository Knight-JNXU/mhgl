...
-- Command line was: D:\Server\Data\NewScript\Item\Item51903.out 

Item51903 = {}
Item51903.MapUse = function(self, target)
  if target and target:GetUserType() == 2 then
    ...
    WaitAnswer(2)
    if GetAnswer() == 1 then
      local NewSkillID = 4603
      local NewSkillName = "残阳晚照式"
...
Item51903.CanUse = function(self, user, target)
end

Item51903.BattleUse = function(self, user, target)
end

AddItemTable(Item51903)
