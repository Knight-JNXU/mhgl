--author: apollo
--武学秘籍 指定宝宝后右击使用：使宝宝学会"高级神佑复生"技能

Item40024 = {
}

function Item40024:MapUse(target)
	if target and target:GetUserType() == 2 then --宝宝
		...
		WaitAnswer(2)
		if GetAnswer() == 1 then			
			local NewSkillID = 307
			local NewSkillName = "高级神佑复生"
...
function Item40024:CanUse(user, target)
end

function Item40024:BattleUse(user, target)

end

AddItemTable(Item40024)