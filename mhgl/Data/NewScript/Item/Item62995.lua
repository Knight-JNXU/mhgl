...
Item61086.MapUse = function(l_1_0, l_1_1)
  ItemAsk("使用角色6倍经验丸，你便可以立即获得1小时的6倍逍遥时间噢！~（时间不可累加）")
  SetAnswer(1, string.format("使用“角色6倍经验丸”"))
  SetAnswer(2, "今天不好用")
  WaitAnswer(2)
  if GetAnswer() == 1 then
   --[[if player:HasBuff(218) then
    ...
    if player:HasBuff(303) then
      ...
      player:AddBuff(111, 0, 0, 0, 60, 100)
	   player:GetItems():RemoveItem(62995, 1)
      ShowHint("成功使用“角色6倍经验丸”，获得1小时角色6倍经验时间。")
    end
  end
