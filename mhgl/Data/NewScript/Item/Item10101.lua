--author: apollo
--武学秘籍 指定同伴后右击使用：使同伴学会"驱鬼"招式

Item10101 = {
}

function Item10101:MapUse(target)
	if target and target:GetUserType() == 2 then --同伴
		...
		WaitAnswer(2)
		if GetAnswer() == 1 then				
			local NewSkillID = 267
			local NewSkillName = "驱鬼"
...
function Item10101:CanUse(user, target)
end

function Item10101:BattleUse(user, target)

end

AddItemTable(Item10101)