...
Item402868 = {}
Item402868.MapUse = function(l_1_0, l_1_1)
  if l_1_1 and l_1_1:GetUserType() == 2 then
    ...
    WaitAnswer(2)
    if GetAnswer() == 1 then
      if l_1_1:GetGrow() >= 2.201 then
        ShowHint("同伴的成长需要在2201以下才能使用")
        return 
      end
...
Item402868.CanUse = function(l_2_0, l_2_1, l_2_2)
end

Item402868.BattleUse = function(l_3_0, l_3_1, l_3_2)
end

AddItemTable(Item402868)
