...
-- Command line was: D:\Server\Data\NewScript\Item\Item51909.out 

Item51909 = {}
Item51909.MapUse = function(self, target)
  if target and target:GetUserType() == 2 then
    ...
    WaitAnswer(2)
    if GetAnswer() == 1 then
      local NewSkillID = 4613
      local NewSkillName = "意守乾坤式"
...
Item51909.CanUse = function(self, user, target)
end

Item51909.BattleUse = function(self, user, target)
end

AddItemTable(Item51909)
