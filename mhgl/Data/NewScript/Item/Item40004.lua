--author: apollo
--武学秘籍 指定宝宝后右击使用：使宝宝学会"高级飞行"技能

Item40004 = {
}

function Item40004:MapUse(target)
	if target and target:GetUserType() == 2 then --宝宝
		...
		WaitAnswer(2)
		if GetAnswer() == 1 then				
			local NewSkillID = 290
			local NewSkillName = "高级飞行"
...
function Item40004:CanUse(user, target)
end

function Item40004:BattleUse(user, target)

end

AddItemTable(Item40004)