--author: apollo
--武学秘籍 指定同伴后右击使用：使同伴学会"反击"招式

Item10080 = {
}

function Item10080:MapUse(target)
	if target and target:GetUserType() == 2 then --同伴
		...
		WaitAnswer(2)
		if GetAnswer() == 1 then													
			local NewSkillID = 248
			local NewSkillName = "反击"
...
function Item10080:CanUse(user, target)
end

function Item10080:BattleUse(user, target)

end

AddItemTable(Item10080)