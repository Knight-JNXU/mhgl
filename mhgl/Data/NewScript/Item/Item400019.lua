...
-- Command line was: Item400019.out 

Item400019 = {}
Item400019.MapUse = function(self, target)
...
Item400019.CanUse = function(self, user, target)
end

Item400019.BattleUse = function(self, user, target)
end

AddItemTable(Item400019)
