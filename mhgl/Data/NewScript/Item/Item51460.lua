...
function Item51460:MapUse(target)
	if target and target:GetUserType() == 2 then --召唤兽
		...
		WaitAnswer(2)
		if GetAnswer() == 1 then				
			local NewSkillID = 4401
			local NewSkillName = "神惊心"
...
function Item51460:CanUse(user, target)
end

function Item51460:BattleUse(user, target)

end

AddItemTable(Item51460)