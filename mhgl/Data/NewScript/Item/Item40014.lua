--author: apollo
--武学秘籍 指定宝宝后右击使用：使宝宝学会"高级招架"技能

Item40014 = {
}

function Item40014:MapUse(target)
	if target and target:GetUserType() == 2 then --宝宝
		...
		WaitAnswer(2)
		if GetAnswer() == 1 then			
			local NewSkillID = 299
			local NewSkillName = "高级招架"
...
function Item40014:CanUse(user, target)
end

function Item40014:BattleUse(user, target)

end

AddItemTable(Item40014)