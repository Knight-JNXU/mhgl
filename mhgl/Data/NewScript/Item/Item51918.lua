...
-- Command line was: D:\Server\Data\NewScript\Item\Item51918.out 

Item51918 = {}
Item51918.MapUse = function(self, target)
  if target and target:GetUserType() == 2 then
    ...
    WaitAnswer(2)
    if GetAnswer() == 1 then
      local NewSkillID = 4630
      local NewSkillName = "金刚解甲式"
...
Item51918.CanUse = function(self, user, target)
end

Item51918.BattleUse = function(self, user, target)
end

AddItemTable(Item51918)
