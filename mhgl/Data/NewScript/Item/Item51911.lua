...
-- Command line was: D:\Server\Data\NewScript\Item\Item51911.out 

Item51911 = {}
Item51911.MapUse = function(self, target)
  if target and target:GetUserType() == 2 then
    ...
    WaitAnswer(2)
    if GetAnswer() == 1 then
      local NewSkillID = 4615
      local NewSkillName = "无量气海式"
...
Item51911.CanUse = function(self, user, target)
end

Item51911.BattleUse = function(self, user, target)
end

AddItemTable(Item51911)
