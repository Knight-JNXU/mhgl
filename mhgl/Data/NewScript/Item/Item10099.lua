--author: apollo
--武学秘籍 指定同伴后右击使用：使同伴学会"偷袭"招式

Item10099 = {
}

function Item10099:MapUse(target)
	if target and target:GetUserType() == 2 then --同伴
		...
		WaitAnswer(2)
		if GetAnswer() == 1 then				
			local NewSkillID = 250
			local NewSkillName = "偷袭"
...
function Item10099:CanUse(user, target)
end

function Item10099:BattleUse(user, target)

end

AddItemTable(Item10099)