...
function Item51304:MapUse(target)
	if target and target:GetUserType() == 1 then --人物
		local NewSkillID = 5
		local NewSkillName = "《蛇蟠阵》"
...
function Item51304:CanUse(user, target)
end

function Item51304:BattleUse(user, target)

end

AddItemTable(Item51304)