--author: apollo
--武学秘籍 指定宝宝后右击使用：使宝宝学会"高级永恒"技能

Item40015 = {
}

function Item40015:MapUse(target)
	if target and target:GetUserType() == 2 then --宝宝
		...
		WaitAnswer(2)
		if GetAnswer() == 1 then			
			local NewSkillID = 300
			local NewSkillName = "高级永恒"
...
function Item40015:CanUse(user, target)
end

function Item40015:BattleUse(user, target)

end

AddItemTable(Item40015)