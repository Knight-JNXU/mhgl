--author: apollo
--武学秘籍 指定宝宝后右击使用：使宝宝学会"高级幸运"技能

Item40012 = {
}

function Item40012:MapUse(target)
	if target and target:GetUserType() == 2 then --宝宝
		...
		WaitAnswer(2)
		if GetAnswer() == 1 then			
			local NewSkillID = 297
			local NewSkillName = "高级幸运"
...
function Item40012:CanUse(user, target)
end

function Item40012:BattleUse(user, target)

end

AddItemTable(Item40012)