...
-- Command line was: Item400038.out 

Item400038 = {}
Item400038.MapUse = function(self, target)
...
Item400038.CanUse = function(self, user, target)
end

Item400038.BattleUse = function(self, user, target)
end

AddItemTable(Item400038)
