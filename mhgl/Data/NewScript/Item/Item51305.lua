...
function Item51305:MapUse(target)
	if target and target:GetUserType() == 1 then --人物
		local NewSkillID = 6
		local NewSkillName = "《鹰啸阵》"
...
function Item51305:CanUse(user, target)
end

function Item51305:BattleUse(user, target)

end

AddItemTable(Item51305)