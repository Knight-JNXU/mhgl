...
function Item60214:MapUse(target)
	if target and target:GetUserType() == 2 then --召唤兽
		...
		WaitAnswer(2)
		if GetAnswer() == 1 then				
			local NewSkillID = 323
			local NewSkillName = "高级土属性吸收"
...
function Item60214:CanUse(user, target)
end

function Item60214:BattleUse(user, target)

end

AddItemTable(Item60214)