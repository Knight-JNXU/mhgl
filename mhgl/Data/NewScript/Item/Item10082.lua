--author: apollo
--武学秘籍 指定同伴后右击使用：使同伴学会真·暗夜破招式

Item10082 = {
}

function Item10082:MapUse(target)
	if target and target:GetUserType() == 2 then --同伴
		...
		WaitAnswer(2)
		if GetAnswer() == 1 then			
			local NewSkillID = 328
			local NewSkillName = "吸血"
...
function Item10082:CanUse(user, target)
end

function Item10082:BattleUse(user, target)

end

AddItemTable(Item10082)