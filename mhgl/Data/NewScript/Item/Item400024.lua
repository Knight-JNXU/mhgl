...
-- Command line was: Item400024.out 

Item400024 = {}
Item400024.MapUse = function(self, target)
...
Item400024.CanUse = function(self, user, target)
end

Item400024.BattleUse = function(self, user, target)
end

AddItemTable(Item400024)
