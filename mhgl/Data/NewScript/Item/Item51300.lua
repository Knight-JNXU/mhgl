...
function Item51300:MapUse(target)
	if target and target:GetUserType() == 1 then --人物
		local NewSkillID = 1
		local NewSkillName = "《雷绝阵》"
...
function Item51300:CanUse(user, target)
end

function Item51300:BattleUse(user, target)

end

AddItemTable(Item51300)