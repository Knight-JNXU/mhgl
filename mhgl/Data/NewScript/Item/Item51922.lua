...
-- Command line was: D:\Server\Data\NewScript\Item\Item51922.out 

Item51922 = {}
Item51922.MapUse = function(self, target)
  if target and target:GetUserType() == 2 then
    ...
    WaitAnswer(2)
    if GetAnswer() == 1 then
      local NewSkillID = 4642
      local NewSkillName = "飞莲踏浪式"
...
Item51922.CanUse = function(self, user, target)
end

Item51922.BattleUse = function(self, user, target)
end

AddItemTable(Item51922)
