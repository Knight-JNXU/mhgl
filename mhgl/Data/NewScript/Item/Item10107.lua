--author: apollo
--武学秘籍 指定同伴后右击使用：使同伴学会"法术连击"招式

Item10107 = {
}

function Item10107:MapUse(target)
	if target and target:GetUserType() == 2 then --同伴
		...
		WaitAnswer(2)
		if GetAnswer() == 1 then				
			local NewSkillID = 278
			local NewSkillName = "法术连击"
...
function Item10107:CanUse(user, target)
end

function Item10107:BattleUse(user, target)

end

AddItemTable(Item10107)