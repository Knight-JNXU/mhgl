...
-- Command line was: D:\Server\Data\NewScript\Item\Item51912.out 

Item51912 = {}
Item51912.MapUse = function(self, target)
  if target and target:GetUserType() == 2 then
    ...
    WaitAnswer(2)
    if GetAnswer() == 1 then
      local NewSkillID = 4620
      local NewSkillName = "正观同尘式"
...
Item51912.CanUse = function(self, user, target)
end

Item51912.BattleUse = function(self, user, target)
end

AddItemTable(Item51912)
