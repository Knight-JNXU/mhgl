--author: apollo
--武学秘籍 指定同伴后右击使用：使同伴学会"招架"招式

Item10094 = {
}

function Item10094:MapUse(target)
	if target and target:GetUserType() == 2 then --同伴
		...
		WaitAnswer(2)
		if GetAnswer() == 1 then				
			local NewSkillID = 261
			local NewSkillName = "招架"
...
function Item10094:CanUse(user, target)
end

function Item10094:BattleUse(user, target)

end

AddItemTable(Item10094)