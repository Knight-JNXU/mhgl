--author: apollo
--武学秘籍 指定同伴后右击使用：使同伴学会"防御"招式

Item10098 = {
}

function Item10098:MapUse(target)
	if target and target:GetUserType() == 2 then --同伴
		...
		WaitAnswer(2)
		if GetAnswer() == 1 then				
			local NewSkillID = 265
			local NewSkillName = "防御"
...
function Item10098:CanUse(user, target)
end

function Item10098:BattleUse(user, target)

end

AddItemTable(Item10098)