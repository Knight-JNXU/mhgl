...
-- Command line was: D:\Server\Data\NewScript\Item\Item51905.out 

Item51905 = {}
Item51905.MapUse = function(self, target)
  if target and target:GetUserType() == 2 then
    ...
    WaitAnswer(2)
    if GetAnswer() == 1 then
      local NewSkillID = 4605
      local NewSkillName = "九阳聚一式"
...
Item51905.CanUse = function(self, user, target)
end

Item51905.BattleUse = function(self, user, target)
end

AddItemTable(Item51905)
