--author: apollo
--武学秘籍 指定同伴后右击使用：使同伴学会"听风辨位"招式

Item10087 = {
}

function Item10087:MapUse(target)
	if target and target:GetUserType() == 2 then --同伴
		...
		WaitAnswer(2)
		if GetAnswer() == 1 then				
			local NewSkillID = 254
			local NewSkillName = "感知"
...
function Item10087:CanUse(user, target)
end

function Item10087:BattleUse(user, target)

end

AddItemTable(Item10087)