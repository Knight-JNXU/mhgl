--author: apollo
--武学秘籍 指定同伴后右击使用：使同伴学会"夺命连环"招式

Item10083 = {
}

function Item10083:MapUse(target)
	if target and target:GetUserType() == 2 then --同伴
		...
		WaitAnswer(2)
		if GetAnswer() == 1 then				
			local NewSkillID = 251
			local NewSkillName = "连击"
...
function Item10083:CanUse(user, target)
end

function Item10083:BattleUse(user, target)

end

AddItemTable(Item10083)