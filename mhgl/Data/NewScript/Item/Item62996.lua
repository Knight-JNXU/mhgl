...
Item61084.MapUse = function(l_1_0, l_1_1)
  ItemAsk("使用同伴6倍经验丸，你便可以立即获得1小时的6倍逍遥时间噢！~（时间不可累加）")
  SetAnswer(1, string.format("使用“同伴6倍经验丸”"))
  SetAnswer(2, "今天不好用")
  WaitAnswer(2)
  if GetAnswer() == 1 then
    ...
    if player:HasBuff(304) then
      ...
      player:AddBuff(112, 0, 0, 0, 60, 100)
	  player:GetItems():RemoveItem(62996, 1)
      ShowHint("成功使用“同伴6倍经验丸”，获得1小时同伴6倍经验时间。")
    end
  end
