--author: apollo
--武学秘籍 指定宝宝后右击使用：使宝宝学会"高级感知"技能

Item40007 = {
}

function Item40007:MapUse(target)
...
function Item40007:CanUse(user, target)
end

function Item40007:BattleUse(user, target)

end

AddItemTable(Item40007)