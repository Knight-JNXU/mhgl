--author: apollo
--武学秘籍 指定同伴后右击使用：使同伴学会"法术暴击"招式

Item10108 = {
}

function Item10108:MapUse(target)
	if target and target:GetUserType() == 2 then --同伴
		...
		WaitAnswer(2)
		if GetAnswer() == 1 then				
			local NewSkillID = 279
			local NewSkillName = "法术暴击"
...
function Item10108:CanUse(user, target)
end

function Item10108:BattleUse(user, target)

end

AddItemTable(Item10108)