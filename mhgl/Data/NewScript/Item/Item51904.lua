...
-- Command line was: D:\Server\Data\NewScript\Item\Item51904.out 

Item51904 = {}
Item51904.MapUse = function(self, target)
  if target and target:GetUserType() == 2 then
    ...
    WaitAnswer(2)
    if GetAnswer() == 1 then
      local NewSkillID = 4604
      local NewSkillName = "烨阳不息式"
...
Item51904.CanUse = function(self, user, target)
end

Item51904.BattleUse = function(self, user, target)
end

AddItemTable(Item51904)
