--author: apollo
--武学秘籍 指定同伴后右击使用：使同伴学会"神佑复生"招式

Item10104 = {
}

function Item10104:MapUse(target)
	if target and target:GetUserType() == 2 then --同伴
		...
		WaitAnswer(2)
		if GetAnswer() == 1 then				
			local NewSkillID = 269
			local NewSkillName = "神佑复生"
...
function Item10104:CanUse(user, target)
end

function Item10104:BattleUse(user, target)

end

AddItemTable(Item10104)