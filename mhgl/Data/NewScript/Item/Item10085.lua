...
function Item10085:MapUse(target)
	if target and target:GetUserType() == 2 then --同伴
		...
		WaitAnswer(2)
		if GetAnswer() == 1 then			
			local NewSkillID = 330
			local NewSkillName = "夜战"
...
function Item10085:CanUse(user, target)
end

function Item10085:BattleUse(user, target)

end

AddItemTable(Item10085)