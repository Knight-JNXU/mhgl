...
function Item51310:MapUse(target)
	if target and target:GetUserType() == 1 then --人物
		local NewSkillID = 11
		local NewSkillName = "《风扬阵》"
...
function Item51310:CanUse(user, target)
end

function Item51310:BattleUse(user, target)

end

AddItemTable(Item51310)