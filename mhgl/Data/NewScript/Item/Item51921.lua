...
-- Command line was: D:\Server\Data\NewScript\Item\Item51921.out 

Item51921 = {}
Item51921.MapUse = function(self, target)
  if target and target:GetUserType() == 2 then
    ...
    WaitAnswer(2)
    if GetAnswer() == 1 then
      local NewSkillID = 4641
      local NewSkillName = "鱼影游踪式"
...
Item51921.CanUse = function(self, user, target)
end

Item51921.BattleUse = function(self, user, target)
end

AddItemTable(Item51921)
