--author: apollo
--武学秘籍 指定同伴后右击使用：使同伴学会"清心普善"招式

Item10095 = {
}

function Item10095:MapUse(target)
	if target and target:GetUserType() == 2 then --同伴
		...
		WaitAnswer(2)
		if GetAnswer() == 1 then				
			local NewSkillID = 262
			local NewSkillName = "永恒"
...
function Item10095:CanUse(user, target)
end

function Item10095:BattleUse(user, target)

end

AddItemTable(Item10095)