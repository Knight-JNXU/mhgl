--author: apollo
--武学秘籍 指定宝宝后右击使用：使宝宝学会"高级必杀"技能

Item40011 = {
}

function Item40011:MapUse(target)
	if target and target:GetUserType() == 2 then --宝宝
		...
		WaitAnswer(2)
		if GetAnswer() == 1 then			
			local NewSkillID = 296
			local NewSkillName = "高级必杀"
...
function Item40011:CanUse(user, target)
end

function Item40011:BattleUse(user, target)

end

AddItemTable(Item40011)