--author: apollo
--武学秘籍 指定宝宝后右击使用：使宝宝学会"高级连击"技能

Item40003 = {
}

function Item40003:MapUse(target)
	if target and target:GetUserType() == 2 then --宝宝
		...
		WaitAnswer(2)
		if GetAnswer() == 1 then				
			local NewSkillID = 289
			local NewSkillName = "高级连击"
...
function Item40003:CanUse(user, target)
end

function Item40003:BattleUse(user, target)

end

AddItemTable(Item40003)