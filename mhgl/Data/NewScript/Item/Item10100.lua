--author: apollo
--武学秘籍 指定同伴后右击使用：使同伴学会"毒"招式

Item10100 = {
}

function Item10100:MapUse(target)
	if target and target:GetUserType() == 2 then --同伴
		...
		WaitAnswer(2)
		if GetAnswer() == 1 then				
			local NewSkillID = 266
			local NewSkillName = "毒"
...
function Item10100:CanUse(user, target)
end

function Item10100:BattleUse(user, target)

end

AddItemTable(Item10100)