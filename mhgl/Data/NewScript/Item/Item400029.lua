...
-- Command line was: Item400029.out 

Item400029 = {}
Item400029.MapUse = function(self, target)
...
Item400029.CanUse = function(self, user, target)
end

Item400029.BattleUse = function(self, user, target)
end

AddItemTable(Item400029)
