...
function Item60206:MapUse(target)
	if target and target:GetUserType() == 2 then --召唤兽
		...
		WaitAnswer(2)
		if GetAnswer() == 1 then				
			local NewSkillID = 312
			local NewSkillName = "泰山压顶"
...
function Item60206:CanUse(user, target)
end

function Item60206:BattleUse(user, target)

end

AddItemTable(Item60206)