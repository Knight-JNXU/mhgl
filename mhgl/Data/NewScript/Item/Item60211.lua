...
function Item60211:MapUse(target)
	if target and target:GetUserType() == 2 then --召唤兽
		...
		WaitAnswer(2)
		if GetAnswer() == 1 then				
			local NewSkillID = 283
			local NewSkillName = "雷属性吸收"
...
function Item60211:CanUse(user, target)
end

function Item60211:BattleUse(user, target)

end

AddItemTable(Item60211)