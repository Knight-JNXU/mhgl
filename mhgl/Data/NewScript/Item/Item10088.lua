--author: apollo
--武学秘籍 指定同伴后右击使用：使同伴学会"再生"招式

Item10088 = {
}

function Item10088:MapUse(target)
	if target and target:GetUserType() == 2 then --同伴
		...
		WaitAnswer(2)
		if GetAnswer() == 1 then				
			local NewSkillID = 255
			local NewSkillName = "再生"
...
function Item10088:CanUse(user, target)
end

function Item10088:BattleUse(user, target)

end

AddItemTable(Item10088)