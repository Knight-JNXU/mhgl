...
function Item51302:MapUse(target)
	if target and target:GetUserType() == 1 then --人物
		local NewSkillID = 3
		local NewSkillName = "《鸟翔阵》"
...
function Item51302:CanUse(user, target)
end

function Item51302:BattleUse(user, target)

end

AddItemTable(Item51302)