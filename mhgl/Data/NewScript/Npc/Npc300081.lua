Npc300081 = {							-- 丁喜
	npc_id = 300081,						-- NPC ID
	name = GetNpcName(300081),				-- NPC 名称
}

-- Npc00019 对话方法，bProcess 为脚本处理阶段
function Npc300081:Talk(bProcess)
				...
				if GetAnswer() == 1 then
					...
					if bProcess then
						if Job == 1 or Job == 4 then
						    ...
						    player:EncounterBattle(300085)
						end
					end
				end
			elseif NpcId == 300082 or NpcId == 300083 or NpcId == 300084 then
			    local npcName = GetNpcName(NpcId)
			    NpcSay(string.format("现在去挑战%s吧。",npcName))
			else
			    NpcSay("科举期间你在这瞎逛什么！")
			end
		end
