...
--十二连环坞护法
Npc00200004 = {npc_id = 00200004, name = GetNpcName(00200004)}
Npc00200004.Talk = function(self, bProcess)
  ...
  if GetAnswer() == 1 then
    ...
    if q:GetTargetMobId(1) < 00200004 then
      ...
      if q and q:GetTargetMobId(1) > 00200004 then
      ...
      player:EncounterBattle(00200004)
    end
  else
