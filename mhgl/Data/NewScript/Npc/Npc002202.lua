...
--十二连环坞护法
Npc002202 = {npc_id = 002202, name = GetNpcName(002202)}
Npc002202.Talk = function(self, bProcess)
  ...
  if GetAnswer() == 1 then
    ...
    if q:GetTargetMobId(1) < 913 then
      ...
      if q and q:GetTargetMobId(1) > 913 then
