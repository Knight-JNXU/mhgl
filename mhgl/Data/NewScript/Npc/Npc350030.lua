...
Npc350030 = {							
	npc_id = 350030,					
	name = GetNpcName(350030),	
}


function Npc350030:Talk(bProcess)	
	if player:GetQuests():HasQuest(60220) and npc and npc:GetNpc_id() == player:GetQuests():GetFlag(60220) then	
		NpcAsk("每次博彩，系统随机生成1-6之间的数，1-3为小，4-6为大。如果你赚了，那我恭喜你；如果你亏了，可不能刷喇叭说是我坑你。")	
		SetAnswer(1, "买大（4-6）")
		SetAnswer(2, "买小（1-3）")
		SetAnswer(3, "都不买")
		WaitAnswer(3)
		if GetAnswer() == 1 then
			...
			SetAnswer(4, "100000")
			SetAnswer(5, "1000000")
			SetAnswer(6, "10000000")
			SetAnswer(7, "我刚不小心点错了。")
			WaitAnswer(7)
			if GetAnswer() == 4 then
				if player:GetMoney() >= 100000 then			    
					if IsProcess() then
						...
						if math.random(0,100) < 60 then					    												
							...
							NpcSay(string.format("\#W随机生成的数为\#P%d\#W，谢谢你送来的\#P10000\#W银两。",math.random(1,3)))												
						else
							player:ChangeMoney(100000)
							ShowError("获得银两100000")
							NpcSay(string.format("\#W随机生成的数为\#P%d\#W，恭喜你获得了\#P10000\#W银两。",math.random(4,6)))						
						end
					end					
				else
					NpcSay(("友情提示：您身上的现金不足。")) 				
				end
			    ...
			    if player:GetMoney() >= 1000000 then			    
					if IsProcess() then
						...
						if math.random(0,100) < 60 then					    												
							...
							NpcSay(string.format("\#W随机生成的数为\#P%d\#W，谢谢你送来的\#P100000\#W银两。",math.random(1,3)))												
						else
							player:ChangeMoney(1000000)
							ShowError("获得银两1000000")
							NpcSay(string.format("\#W随机生成的数为\#P%d\#W，恭喜你获得了\#P100000\#W银两。",math.random(4,6)))	
						end
					end					
				else
					NpcSay(("友情提示：您身上的现金不足。")) 				
			    ...
			    if player:GetMoney() >= 10000000 then			    
					if IsProcess() then
						...
						if math.random(0,100) < 60 then					    												
							...
							NpcSay(string.format("\#W随机生成的数为\#P%d\#W，谢谢你送来的\#P1000000\#W银两。",math.random(1,3)))												
						else
							player:ChangeMoney(10000000)
							ShowError("获得银两10000000")
							NpcSay(string.format("\#W随机生成的数为\#P%d\#W，恭喜你获得了\#P1000000\#W银两。",math.random(4,6)))	
						end
					end					
				else
					NpcSay(("友情提示：您身上的现金不足。")) 				
		...
		elseif GetAnswer() == 2 then
			...
			SetAnswer(8, "100000")
			SetAnswer(9, "1000000")
			SetAnswer(10, "10000000")
			SetAnswer(11, "我刚不小心点错了。")
			WaitAnswer(11)
			if GetAnswer() == 8 then
				if player:GetMoney() >= 100000 then			    
					if IsProcess() then
						...
						if math.random(0,100) < 60 then					    												
							player:ChangeMoney(-100000)
							NpcSay(string.format("\#W随机生成的数为\#P%d\#W，谢谢你送来的\#P10000\#W银两。",math.random(4,6)))												
						else
							player:ChangeMoney(100000)
							ShowError("获得银两100000")
							NpcSay(string.format("\#W随机生成的数为\#P%d\#W，恭喜你获得了\#P10000\#W银两。",math.random(1,3)))	
						end
					end					
				else
					NpcSay(("友情提示：您身上的现金不足。")) 				
			...
			elseif GetAnswer() == 9 then
			    if player:GetMoney() >= 1000000 then			    
					if IsProcess() then
						...
						if math.random(0,100) < 60 then					    												
							player:ChangeMoney(-1000000)
							NpcSay(string.format("\#W随机生成的数为\#P%d\#W，谢谢你送来的\#P100000\#W银两。",math.random(4,6)))												
						else
							player:ChangeMoney(1000000)
							ShowError("获得银两1000000")
							NpcSay(string.format("\#W随机生成的数为\#P%d\#W，恭喜你获得了\#P100000\#W银两。",math.random(1,3)))	
						end
					end					
				else
					NpcSay(("友情提示：您身上的现金不足。")) 				
			...
			elseif GetAnswer() == 10 then
			    if player:GetMoney() >= 10000000 then			    
					if IsProcess() then
						...
						if math.random(0,100) < 60 then					    												
							player:ChangeMoney(-10000000)
							NpcSay(string.format("\#W随机生成的数为\#P%d\#W，谢谢你送来的\#P1000000\#W银两。",math.random(4,6)))												
						else
							player:ChangeMoney(10000000)
							ShowError("获得银两10000000")
							NpcSay(string.format("\#W随机生成的数为\#P%d\#W，恭喜你获得了\#P1000000\#W银两。",math.random(1,3)))	
						end
					end					
				else
					NpcSay(("友情提示：您身上的现金不足。")) 				
