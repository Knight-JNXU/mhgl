...
function Npc00450:Talk(bProcess)
  ...
  if HasQuest(quest_ids)  then 
	...
	if GetAnswer() == 1 then
		...
		if GetAnswer() == 1 then
		  ...
		  if (job == 1 and sex == 0) or (job == 2 and sex == 1) or (job == 3 and sex == 1) then 
		    NpcSay("很好,现在你已是龙宫弟子,为师传你一招\#P水遁\#W，方便你随时返回门派。")
	...
	elseif GetAnswer() == 2 then
		if player:GetSkillLv(10000) < 1 then
		  NpcSay("本门武学从不外传。")
		  return
	  end
	 if bProcess then
