...
--十二连环坞护法
Npc350151 = {npc_id = 350151, name = GetNpcName(350151)}
Npc350151.Talk = function(self, bProcess)
  ...
  if GetAnswer() == 1 then
    ...
    if q:GetTargetMobId(1) < 350151 then
      ...
      if q and q:GetTargetMobId(1) > 350151 then
