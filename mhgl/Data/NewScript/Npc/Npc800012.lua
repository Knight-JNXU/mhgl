...
--十二连环坞护法
Npc800012 = {npc_id = 800012, name = GetNpcName(800012)}
Npc800012.Talk = function(self, bProcess)
  ...
  if GetAnswer() == 1 then
    ...
    if q:GetTargetMobId(1) < 800012 then
      ...
      if q and q:GetTargetMobId(1) > 800012 then
