      ...
      for i = 0, party:GetCount() - 1 do
        ...
        if qtype == nil or TotalRound79009 < 150 then
          if member:GetLevel() >= 69 then
            if member:GetItems():GetItemCount(402911) > 0 or member:GetItems():GetItemCount(402911) > 0 then
              cardnum = cardnum + 1
            else
...
if l_1_1 then
  for i = 0, party:GetCount() - 1 do
      --[[local member = party:GetMember(i)
      if member:GetItems():GetItemCount(402911) > 0 then
         member:GetItems():RemoveItem(402911)
      elseif member:GetItems():GetItemCount(402911) > 0 then
         member:GetItems():RemoveItem(402911)
      end]]
  end
end
