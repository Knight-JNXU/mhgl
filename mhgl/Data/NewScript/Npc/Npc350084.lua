...
--十二连环坞护法
Npc350084 = {npc_id = 350084, name = GetNpcName(350084)}
Npc350084.Talk = function(self, bProcess)
  ...
  local quest63531 = player:GetQuests():GetQuest(63531)
    ...
    if q:GetTargetMobId(1) < 350084 then
      ...
      if q and q:GetTargetMobId(1) > 350084 then
