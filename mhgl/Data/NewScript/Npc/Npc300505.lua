...
--万福万寿园护法
Npc300505 = {npc_id = 300505, name = GetNpcName(300505)}
Npc300505.Talk = function(self, bProcess)
  ...
  if GetAnswer() == 1 then
    ...
    if q:GetTargetMobId(1) < 471 then
      ...
      if q and q:GetTargetMobId(1) > 471 then
