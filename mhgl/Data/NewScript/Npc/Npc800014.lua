...
--十二连环坞护法
Npc800014 = {npc_id = 800014, name = GetNpcName(800014)}
Npc800014.Talk = function(self, bProcess)
  ...
  if GetAnswer() == 1 then
    ...
    if q:GetTargetMobId(1) < 800014 then
      ...
      if q and q:GetTargetMobId(1) > 800014 then
