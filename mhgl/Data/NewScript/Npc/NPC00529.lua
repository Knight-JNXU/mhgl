...
--十二连环坞护法
Npc000529 = {npc_id = 529, name = GetNpcName(529)}
Npc000529.Talk = function(self, bProcess)
  ...
  if GetAnswer() == 1 then
    ...
    if q:GetTargetMobId(1) < 529 then
      ...
      if q and q:GetTargetMobId(1) > 529 then
