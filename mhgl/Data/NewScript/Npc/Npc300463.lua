...
Npc300463 = {							-- 蝎子
	npc_id = 300463,						-- NPC ID
	name = GetNpcName(300463),				-- NPC 名称
										-- NPC 会派出的任务表
}

-- 对话方法，bProcess 为脚本处理阶段
function Npc300463:Talk(bProcess)
	...
	if npc and Q and Q:GetTargetNpcId(1) == npc:GetNpc_id() and 
		...
		NpcAsk("我就是五毒之一蝎子，夏天已到，终于可以出去晃悠了！")
