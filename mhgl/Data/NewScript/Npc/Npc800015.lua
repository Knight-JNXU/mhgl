...
--十二连环坞护法
Npc800015 = {npc_id = 800015, name = GetNpcName(800015)}
Npc800015.Talk = function(self, bProcess)
  ...
  if GetAnswer() == 1 then
    ...
    if q:GetTargetMobId(1) < 800015 then
      ...
      if q and q:GetTargetMobId(1) > 800015 then
