...
function Npc00034:Talk(bProcess)
	...
	local quest69208 = player:GetQuests():GetQuest(69208)
	if (HasQuest(26001) and quest26001:GetEndNpcId() == self.npc_id) or
		...
		NpcAsk("你是来找我的吗？我美吗！"..RandomLine(10))
		if (HasQuest(26001) and quest26001:GetEndNpcId() == self.npc_id) or
			(HasQuest(26002) and quest26002:GetEndNpcId() == self.npc_id) or
			(HasQuest(26003) and quest26003:GetEndNpcId() == self.npc_id) or
	  ...
	  elseif GetAnswer() == 2 then
		...
		NpcAsk("这里四季如春，真是美不胜收！"..RandomLine(10))
		SetAnswer(1,"离开")
		WaitAnswer(1)
	end
end
