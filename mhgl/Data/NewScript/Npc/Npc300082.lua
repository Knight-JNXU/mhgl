Npc300082 = {							-- 丁喜
	npc_id = 300082,						-- NPC ID
	name = GetNpcName(300082),				-- NPC 名称
}

-- Npc00019 对话方法，bProcess 为脚本处理阶段
function Npc300082:Talk(bProcess)
				...
				if GetAnswer() == 1 then
					...
					if bProcess then
						if Job == 1 or Job == 4 then
						    ...
						    player:EncounterBattle(300086)
						end
					end
				end
			elseif NpcId == 300083 or NpcId == 300084 then
