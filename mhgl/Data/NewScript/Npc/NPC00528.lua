...
--十二连环坞护法
Npc528 = {npc_id = 528, name = GetNpcName(528)}
Npc528.Talk = function(self, bProcess)
  ...
  if GetAnswer() == 1 then
    ...
    if q:GetTargetMobId(1) < 528 then
      ...
      if q and q:GetTargetMobId(1) > 528 then
