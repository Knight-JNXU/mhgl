...
Npc300095 = {							-- 龙舟接引人10
	npc_id = 300095,						-- NPC ID
	name = GetNpcName(300095),				-- NPC 名称
										-- NPC 会派出的任务表
}

-- Npc00019 对话方法，bProcess 为脚本处理阶段
function Npc300095:Talk(bProcess)
	if npc then
		NpcAsk("欢迎参加中国梦幻古龙游泳大赛，我是10号接引人。")
		SetAnswer(1,"开始挑战")
		SetAnswer(2,"挑战蛤蟆")
		SetAnswer(3,"等等，还没准备好")
		WaitAnswer(3)
		if GetAnswer() == 1 then
