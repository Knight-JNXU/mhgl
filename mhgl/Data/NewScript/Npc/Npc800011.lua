...
--十二连环坞护法
Npc800011 = {npc_id = 800011, name = GetNpcName(800011)}
Npc800011.Talk = function(self, bProcess)
  ...
  if GetAnswer() == 1 then
    ...
    if q:GetTargetMobId(1) < 800011 then
      ...
      if q and q:GetTargetMobId(1) > 800011 then
