...
--鬼域护法
Npc300508 = {npc_id = 300508, name = GetNpcName(300508)}
Npc300508.Talk = function(self, bProcess)
  ...
  if GetAnswer() == 1 then
    ...
    if q:GetTargetMobId(1) < 474 then
      ...
      if q and q:GetTargetMobId(1) > 474 then
