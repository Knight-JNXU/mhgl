...
Npc00510.Talk = function(l_1_0, l_1_1)
  ...
  if npc then
    ...
    if GetAnswer() == 1 then
      ...
      local itemid = RandTable({401669,402800,15006,15007,15008,15009,20000,30000})
     player:GetItems():AddItem(itemid, 1)
    ShowError(string.format("#W獲得%s", GetItemName(itemid)))
     script:Rumor(string.format("%s #O诚心诚意的向本服大神膜拜，竟然得到了大神的青睐！特赐给#Y%s#0101#0101#0101", player:GetCharNameLink(), GetItemName(itemid)), false)
       	end
		end
    if GetAnswer() == 2 then
