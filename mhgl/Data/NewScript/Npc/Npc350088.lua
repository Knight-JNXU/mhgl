...
--十二连环坞护法
Npc350088 = {npc_id = 350088, name = GetNpcName(350088)}
Npc350088.Talk = function(self, bProcess)
  ...
  if GetAnswer() == 1 then
    ...
    if q:GetTargetMobId(1) < 350088 then
      ...
      if q and q:GetTargetMobId(1) > 350088 then
