...
--十二连环坞护法
Npc350080 = {npc_id = 350080, name = GetNpcName(350080)}
Npc350080.Talk = function(self, bProcess)
  ...
  if GetAnswer() == 1 then
    ...
    if q:GetTargetMobId(1) < 350080 then
      ...
      if q and q:GetTargetMobId(1) > 350080 then
