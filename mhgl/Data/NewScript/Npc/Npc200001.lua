...
--十二连环坞护法
Npc00200001 = {npc_id = 00200001, name = GetNpcName(00200001)}
Npc00200001.Talk = function(self, bProcess)
  ...
  if GetAnswer() == 1 then
    ...
    if q:GetTargetMobId(1) < 00200001 then
      ...
      if q and q:GetTargetMobId(1) > 00200001 then
      ...
      player:EncounterBattle(00200001)
    end
  else
