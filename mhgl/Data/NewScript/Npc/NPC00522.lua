...
--十二连环坞护法
Npc000522 = {npc_id = 522, name = GetNpcName(522)}
Npc000522.Talk = function(self, bProcess)
  ...
  if GetAnswer() == 1 then
    ...
    if q:GetTargetMobId(1) < 522 then
      ...
      if q and q:GetTargetMobId(1) > 522 then
