...
--十二连环坞护法
Npc00200000 = {npc_id = 200000, name = GetNpcName(200000)}
Npc00200000.Talk = function(self, bProcess)
  ...
  if GetAnswer() == 1 then
    ...
    if q:GetTargetMobId(1) < 200000 then
      ...
      if q and q:GetTargetMobId(1) > 200000 then
