...
--鬼域护法
Npc300507 = {npc_id = 300507, name = GetNpcName(300507)}
Npc300507.Talk = function(self, bProcess)
  ...
  if GetAnswer() == 1 then
    ...
    if q:GetTargetMobId(1) < 473 then
      ...
      if q and q:GetTargetMobId(1) > 473 then
