...
--十二连环坞护法
Npc350150 = {npc_id = 350150, name = GetNpcName(350150)}
Npc350150.Talk = function(self, bProcess)
  ...
  if GetAnswer() == 1 then
    ...
    if q:GetTargetMobId(1) < 350150 then
      ...
      if q and q:GetTargetMobId(1) > 350150 then
