		...
		if flag60221 == 0 then		
			...
			elseif GetAnswer() == 1 then
				if player:GetMoney() >= 200000 then
				    ...
				    NpcSay("\#W您的现金不足\#P200000\#W，请及时取款。")
			    end
			end							
