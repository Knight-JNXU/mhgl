...
--普陀山
Npc300502 = {npc_id = 300502, name = GetNpcName(300502)}
Npc300502.Talk = function(self, bProcess)
  ...
  if GetAnswer() == 1 then
    ...
    if q:GetTargetMobId(1) < 468 then
      ...
      if q and q:GetTargetMobId(1) > 468 then
