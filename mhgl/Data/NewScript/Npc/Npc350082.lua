...
--十二连环坞护法
Npc350082 = {npc_id = 350082, name = GetNpcName(350082)}
Npc350082.Talk = function(self, bProcess)
  ...
  if GetAnswer() == 1 then
    ...
    if q:GetTargetMobId(1) < 350082 then
      ...
      if q and q:GetTargetMobId(1) > 350082 then
