...
--十二连环坞护法
Npc523 = {npc_id = 523, name = GetNpcName(523)}
Npc523.Talk = function(self, bProcess)
  ...
  if GetAnswer() == 1 then
    ...
    if q:GetTargetMobId(1) < 523 then
      ...
      if q and q:GetTargetMobId(1) > 523 then
