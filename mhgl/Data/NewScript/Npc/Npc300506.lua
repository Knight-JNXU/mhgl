...
--青衣楼护法
Npc300506 = {npc_id = 300506, name = GetNpcName(300506)}
Npc300506.Talk = function(self, bProcess)
  ...
  if GetAnswer() == 1 then
    ...
    if q:GetTargetMobId(1) < 472 then
      ...
      if q and q:GetTargetMobId(1) > 472 then
