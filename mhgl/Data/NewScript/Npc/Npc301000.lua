Npc301000 = {							-- 魔神蚩尤 仙境传说活动
	npc_id = 301000,						-- NPC ID
	name = GetNpcName(301000),				-- NPC 名称
}

function Npc301000:Talk(bProcess)
    ...
    if GetAnswer() == 1 then
	    if party == nil or party:GetRealMemNum() < 3  then
		    ...
		    if party:GetInPartyMember(0):GetLevel() < 60 then
				NpcSayParty({"小朋友，想和我过招好歹也练到60级再来吧。"
						})
				return false
			end
