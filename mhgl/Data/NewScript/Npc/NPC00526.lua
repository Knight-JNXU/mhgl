...
--十二连环坞护法
Npc526 = {npc_id = 526, name = GetNpcName(526)}
Npc526.Talk = function(self, bProcess)
  ...
  if GetAnswer() == 1 then
    ...
    if q:GetTargetMobId(1) < 526 then
      ...
      if q and q:GetTargetMobId(1) > 526 then
