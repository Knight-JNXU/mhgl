...
--十二连环坞护法
Npc350085 = {npc_id = 350085, name = GetNpcName(350085)}
Npc350085.Talk = function(self, bProcess)
  ...
  if GetAnswer() == 1 then
    ...
    if q:GetTargetMobId(1) < 350085 then
      ...
      if q and q:GetTargetMobId(1) > 350085 then
