...
--鬼域护法
Npc300511 = {npc_id = 300511, name = GetNpcName(300511)}
Npc300511.Talk = function(self, bProcess)
  ...
  if GetAnswer() == 1 then
    ...
    if q:GetTargetMobId(1) < 477 then
      ...
      if q and q:GetTargetMobId(1) > 477 then
