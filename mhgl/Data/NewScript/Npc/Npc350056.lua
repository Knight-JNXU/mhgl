...
function Npc350056:Talk(bProcess)	
	if npc and npc:GetNpc_id() == player:GetQuests():GetFlag(60220) then	
		...
		if flag60221 == 0 then		
			...
			if GetAnswer() == 2 or GetAnswer() == 3 or GetAnswer() == 4 or GetAnswer() == 5  then
				NpcSay("\#W对不起，您选定的物品已售空。")
