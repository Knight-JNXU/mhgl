...
--十二连环坞护法
Npc002201 = {npc_id = 002201, name = GetNpcName(002201)}
Npc002201.Talk = function(self, bProcess)
  ...
  if GetAnswer() == 1 then
    ...
    if q:GetTargetMobId(1) < 912 then
      ...
      if q and q:GetTargetMobId(1) > 912 then
