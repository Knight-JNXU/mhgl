...
--十二连环坞护法
Npc002203 = {npc_id = 002203, name = GetNpcName(002203)}
Npc002203.Talk = function(self, bProcess)
  ...
  if GetAnswer() == 1 then
    ...
    if q:GetTargetMobId(1) < 914 then
      ...
      if q and q:GetTargetMobId(1) > 914 then
