...
--十二连环坞护法
Npc350152 = {npc_id = 350152, name = GetNpcName(350152)}
Npc350152.Talk = function(self, bProcess)
  ...
  if GetAnswer() == 1 then
    ...
    if q:GetTargetMobId(1) < 350152 then
      ...
      if q and q:GetTargetMobId(1) > 350152 then
