...
--十二连环坞护法
Npc000521 = {npc_id = 521, name = GetNpcName(521)}
Npc000521.Talk = function(self, bProcess)
  ...
  if GetAnswer() == 1 then
    ...
    if q:GetTargetMobId(1) < 521 then
      ...
      if q and q:GetTargetMobId(1) > 521 then
