...
--十二连环坞护法
Npc350086 = {npc_id = 350086, name = GetNpcName(350086)}
Npc350086.Talk = function(self, bProcess)
  ...
  if GetAnswer() == 1 then
    ...
    if q:GetTargetMobId(1) < 350086 then
      ...
      if q and q:GetTargetMobId(1) > 350086 then
