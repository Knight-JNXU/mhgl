...
--银钩雪坊护法
Npc300503 = {npc_id = 300503, name = GetNpcName(300503)}
Npc300503.Talk = function(self, bProcess)
  ...
  if GetAnswer() == 1 then
    ...
    if q:GetTargetMobId(1) < 469 then
      ...
      if q and q:GetTargetMobId(1) > 469 then
