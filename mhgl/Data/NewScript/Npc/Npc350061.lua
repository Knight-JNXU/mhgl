		...
		if flag60221 == 0 then
		    ...
		    if GetAnswer() == 1 then
			    if player:GetMoney() >= 1000 then			    
					if IsProcess() then
                        ...
                        local p = math.random(0,90)
						if p > 50 then					    				
							player:ChangeMoney(1000)							
	                        NpcSay("\#W恭喜你获得了1000银两。")						
						else
						    player:ChangeMoney(-1000)
	                        NpcSay("\#W谢谢你送来的1000银两。")	
					    end
				    end					
				else
			    ...
			    if player:GetMoney() >= 10000 then			    
					if IsProcess() then
						...
						if p > 50 then					    				
	                        ...
	                        NpcSay("\#W恭喜你获得了10000银两。")						
						else
						    player:ChangeMoney(-10000)						
	                        NpcSay("\#W谢谢你送来的10000银两。")	
					    end
				    end						
				else
				    NpcSay(("友情提示：您身上的现金不足。")) 
			...
			elseif GetAnswer() == 3 then
			    if player:GetMoney() >= 100000 then			    
					if IsProcess() then
					    script:SetSaying(true)
                        local p = math.random(0,80)
						if p > 50 then					    				
							player:ChangeMoney(100000)							
	                        NpcSay("\#W恭喜你获得了100000银两。")						
						else
						    player:ChangeMoney(-100000)							
	                        NpcSay("\#W谢谢你送来的100000银两。")	
					    end
				    end	
				else
				    NpcSay(("友情提示：您身上的现金不足。")) 
			    ...
			    if player:GetMoney() >= 1000000 then			    
					if IsProcess() then
						...
						if p > 50 then					    				
	                        ...
	                        NpcSay("\#W恭喜你获得了1000000银两。")						
						else
						    player:ChangeMoney(-1000000)							
	                        NpcSay("\#W谢谢你送来的1000000银两。")	
					    end
				    end	
				else
				    NpcSay(("友情提示：您身上的现金不足。")) 
