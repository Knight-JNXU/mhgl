...
--十二连环坞护法
Npc350081 = {npc_id = 350081, name = GetNpcName(350081)}
Npc350081.Talk = function(self, bProcess)
  ...
  if GetAnswer() == 1 then
    ...
    if q:GetTargetMobId(1) < 350081 then
      ...
      if q and q:GetTargetMobId(1) > 350081 then
