...
--十二连环坞护法
Npc527 = {npc_id = 527, name = GetNpcName(527)}
Npc527.Talk = function(self, bProcess)
  ...
  if GetAnswer() == 1 then
    ...
    if q:GetTargetMobId(1) < 527 then
      ...
      if q and q:GetTargetMobId(1) > 527 then
