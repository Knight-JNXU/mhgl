...
--十二连环坞护法
Npc370002 = {npc_id = 370002, name = GetNpcName(370002)}
Npc370002.Talk = function(self, bProcess)
  ...
  if GetAnswer() == 1 then
    ...
    if q:GetTargetMobId(1) < 370002 then
      ...
      if q and q:GetTargetMobId(1) > 370002 then
