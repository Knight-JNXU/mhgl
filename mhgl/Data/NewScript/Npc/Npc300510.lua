...
--鬼域护法
Npc300510 = {npc_id = 300510, name = GetNpcName(300510)}
Npc300510.Talk = function(self, bProcess)
  ...
  if GetAnswer() == 1 then
    ...
    if q:GetTargetMobId(1) < 476 then
      ...
      if q and q:GetTargetMobId(1) > 476 then
