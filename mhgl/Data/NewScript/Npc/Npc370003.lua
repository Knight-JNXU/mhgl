...
--十二连环坞护法
Npc370003 = {npc_id = 370003, name = GetNpcName(370003)}
Npc370003.Talk = function(self, bProcess)
  ...
  if GetAnswer() == 1 then
    ...
    if q:GetTargetMobId(1) < 370003 then
      ...
      if q and q:GetTargetMobId(1) > 370003 then
