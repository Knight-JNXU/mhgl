...
--鬼域护法
Npc300509 = {npc_id = 300509, name = GetNpcName(300509)}
Npc300509.Talk = function(self, bProcess)
  ...
  if GetAnswer() == 1 then
    ...
    if q:GetTargetMobId(1) < 475 then
      ...
      if q and q:GetTargetMobId(1) > 475 then
