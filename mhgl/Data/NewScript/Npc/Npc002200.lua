...
--十二连环坞护法
Npc002200 = {npc_id = 002200, name = GetNpcName(002200)}
Npc002200.Talk = function(self, bProcess)
  ...
  if GetAnswer() == 1 then
    ...
    if q:GetTargetMobId(1) < 911 then
      ...
      if q and q:GetTargetMobId(1) > 911 then
