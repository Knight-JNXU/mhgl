...
--十二连环坞护法
Npc300501 = {npc_id = 300501, name = GetNpcName(300501)}
Npc300501.Talk = function(self, bProcess)
  ...
  if GetAnswer() == 1 then
    ...
    if q:GetTargetMobId(1) < 467 then
      ...
      if q and q:GetTargetMobId(1) > 467 then
