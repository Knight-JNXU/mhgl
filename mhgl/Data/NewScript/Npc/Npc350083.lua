...
--十二连环坞护法
Npc350083 = {npc_id = 350083, name = GetNpcName(350083)}
Npc350083.Talk = function(self, bProcess)
  ...
  if GetAnswer() == 1 then
    ...
    if q:GetTargetMobId(1) < 350083 then
      ...
      if q and q:GetTargetMobId(1) > 350083 then
