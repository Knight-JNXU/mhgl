...
--十二连环坞护法
Npc524 = {npc_id = 524, name = GetNpcName(524)}
Npc524.Talk = function(self, bProcess)
  ...
  if GetAnswer() == 1 then
    ...
    if q:GetTargetMobId(1) < 524 then
      ...
      if q and q:GetTargetMobId(1) > 524 then
