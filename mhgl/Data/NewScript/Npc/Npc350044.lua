...
Npc350044 = {							
	npc_id = 350044,					
	name = GetNpcName(350044),	
}

function Npc350044:Talk(bProcess)	
	if npc and npc:GetNpc_id() == player:GetQuests():GetFlag(60220) then	
		...
		if flag60221 == 0 then
			...
			elseif p <= 4 then
				...
				return			
			elseif p <= 5 then
				NpcSay("\#W身为一名古民，你竟然在公开场合乱扔垃圾物品，罚你\#P100000\#W银两，以示警告，下不为例！")
			...
			elseif p <= 7 then
			    NpcSay("\#W你育新有功，特奖励你\#P200\#W点侠义值，以资鼓励。")				
				player:ChangeGoodness(200)
				player:GetQuests():SetFlag(60221,1)
				return
			elseif p <= 8 then
			    NpcSay("\#W你捉鬼有功，特奖励你一个金柳露，以资鼓励。")
