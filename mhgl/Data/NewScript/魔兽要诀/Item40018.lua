--author: apollo
--武学秘籍 指定宝宝后右击使用：使宝宝学会"高级防御"技能

Item40018 = {
}

function Item40018:MapUse(target)
	if target and target:GetUserType() == 2 then --宝宝
		...
		WaitAnswer(2)
		if GetAnswer() == 1 then			
			local NewSkillID = 303
			local NewSkillName = "高级防御"
...
function Item40018:CanUse(user, target)
end

function Item40018:BattleUse(user, target)

end

AddItemTable(Item40018)