--author: apollo
--武学秘籍 指定宝宝后右击使用：使宝宝学会"高级毒"技能

Item40020 = {
}

function Item40020:MapUse(target)
	if target and target:GetUserType() == 2 then --宝宝
		...
		WaitAnswer(2)
		if GetAnswer() == 1 then			
			local NewSkillID = 304
			local NewSkillName = "高级毒"
...
function Item40020:CanUse(user, target)
end

function Item40020:BattleUse(user, target)

end

AddItemTable(Item40020)