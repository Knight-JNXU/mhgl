--author: apollo
--武学秘籍 指定宝宝后右击使用：使宝宝学会"高级魔之心"技能

Item40023 = {
}

function Item40023:MapUse(target)
	if target and target:GetUserType() == 2 then --宝宝
		...
		WaitAnswer(2)
		if GetAnswer() == 1 then			
			local NewSkillID = 308
			local NewSkillName = "高级魔之心"
...
function Item40023:CanUse(user, target)
end

function Item40023:BattleUse(user, target)

end

AddItemTable(Item40023)