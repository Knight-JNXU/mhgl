--author: apollo
--武学秘籍 指定宝宝后右击使用：使宝宝学会"高级神迹"技能

Item40013 = {
}

function Item40013:MapUse(target)
	if target and target:GetUserType() == 2 then --宝宝
		...
		WaitAnswer(2)
		if GetAnswer() == 1 then			
			local NewSkillID = 298
			local NewSkillName = "高级神迹"
...
function Item40013:CanUse(user, target)
end

function Item40013:BattleUse(user, target)

end

AddItemTable(Item40013)