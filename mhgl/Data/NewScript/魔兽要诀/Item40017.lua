--author: apollo
--武学秘籍 指定宝宝后右击使用：使宝宝学会"高级强力"技能

Item40017 = {
}

function Item40017:MapUse(target)
	if target and target:GetUserType() == 2 then --宝宝
		...
		WaitAnswer(2)
		if GetAnswer() == 1 then			
			local NewSkillID = 302
			local NewSkillName = "高级强力"
...
function Item40017:CanUse(user, target)
end

function Item40017:BattleUse(user, target)

end

AddItemTable(Item40017)