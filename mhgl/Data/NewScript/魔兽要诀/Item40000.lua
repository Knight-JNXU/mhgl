--author: apollo
--武学秘籍 指定宝宝后右击使用：使宝宝学会"真·扭转乾坤"技能

Item40000 = {
}

function Item40000:MapUse(target)
	if target and target:GetUserType() == 2 then --宝宝
		...
		WaitAnswer(2)
		if GetAnswer() == 1 then				
			local NewSkillID = 286
			local NewSkillName = "高级反击"
...
function Item40000:CanUse(user, target)
end

function Item40000:BattleUse(user, target)

end

AddItemTable(Item40000)