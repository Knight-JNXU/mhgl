--author: apollo
--武学秘籍 指定宝宝后右击使用：使宝宝学会高级夜战技能

Item40005 = {
}

function Item40005:MapUse(target)
	if target and target:GetUserType() == 2 then --宝宝
		...
		WaitAnswer(2)
		if GetAnswer() == 1 then			
			local NewSkillID = 333
			local NewSkillName = "高级夜战"
...
function Item40005:CanUse(user, target)
end

function Item40005:BattleUse(user, target)

end

AddItemTable(Item40005)