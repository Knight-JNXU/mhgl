--author: apollo
--武学秘籍 指定宝宝后右击使用：使宝宝学会"高级偷袭"技能

Item40019 = {
}

function Item40019:MapUse(target)
	if target and target:GetUserType() == 2 then --宝宝
		...
		WaitAnswer(2)
		if GetAnswer() == 1 then				
			local NewSkillID = 288
			local NewSkillName = "高级偷袭"
...
function Item40019:CanUse(user, target)
end

function Item40019:BattleUse(user, target)

end

AddItemTable(Item40019)