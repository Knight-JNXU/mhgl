--author: apollo
--武学秘籍 指定宝宝后右击使用：使宝宝学会"高级否定信仰"技能

Item40026 = {
}

function Item40026:MapUse(target)
	if target and target:GetUserType() == 2 then --宝宝
		...
		WaitAnswer(2)
		if GetAnswer() == 1 then			
			local NewSkillID = 310
			local NewSkillName = "高级否定信仰"
...
function Item40026:CanUse(user, target)
end

function Item40026:BattleUse(user, target)

end

AddItemTable(Item40026)