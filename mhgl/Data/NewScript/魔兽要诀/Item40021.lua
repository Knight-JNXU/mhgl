--author: apollo
--武学秘籍 指定宝宝后右击使用：使宝宝学会"高级驱鬼"技能

Item40021 = {
}

function Item40021:MapUse(target)
	if target and target:GetUserType() == 2 then --宝宝
		...
		WaitAnswer(2)
		if GetAnswer() == 1 then			
			local NewSkillID = 305
			local NewSkillName = "高级驱鬼"
...
function Item40021:CanUse(user, target)
end

function Item40021:BattleUse(user, target)

end

AddItemTable(Item40021)