--author: apollo
--武学秘籍 指定宝宝后右击使用：使宝宝学会"高级精神集中"技能

Item40025 = {
}

function Item40025:MapUse(target)
	if target and target:GetUserType() == 2 then --宝宝
		...
		WaitAnswer(2)
		if GetAnswer() == 1 then			
			local NewSkillID = 309
			local NewSkillName = "高级精神集中"
...
function Item40025:CanUse(user, target)
end

function Item40025:BattleUse(user, target)

end

AddItemTable(Item40025)