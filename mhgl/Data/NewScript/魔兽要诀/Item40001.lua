--author: apollo
--武学秘籍 指定宝宝后右击使用：使宝宝学会"真·移花接木"技能

Item40001 = {
}

function Item40001:MapUse(target)
	if target and target:GetUserType() == 2 then --宝宝
		...
		WaitAnswer(2)
		if GetAnswer() == 1 then				
			local NewSkillID = 287
			local NewSkillName = "高级反震"
...
function Item40001:CanUse(user, target)
end

function Item40001:BattleUse(user, target)

end

AddItemTable(Item40001)