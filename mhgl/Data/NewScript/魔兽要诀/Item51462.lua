...
function Item51462:MapUse(target)
	if target and target:GetUserType() == 2 then --召唤兽
		...
		WaitAnswer(2)
		if GetAnswer() == 1 then				
			local NewSkillID = 4406
			local NewSkillName = "神上古"
...
function Item51462:CanUse(user, target)
end

function Item51462:BattleUse(user, target)

end

AddItemTable(Item51462)