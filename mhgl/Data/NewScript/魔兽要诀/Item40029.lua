--author: apollo
--武学秘籍 指定宝宝后右击使用：使宝宝学会"高级法术波动"技能

Item40029 = {
}

function Item40029:MapUse(target)
	if target and target:GetUserType() == 2 then --宝宝
		...
		WaitAnswer(2)
		if GetAnswer() == 1 then			
			local NewSkillID = 318
			local NewSkillName = "高级法术波动"
...
function Item40029:CanUse(user, target)
end

function Item40029:BattleUse(user, target)

end

AddItemTable(Item40029)