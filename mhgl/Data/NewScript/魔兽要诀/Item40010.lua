--author: apollo
--武学秘籍 指定宝宝后右击使用：使宝宝学会"高级慧根"技能

Item40010 = {
}

function Item40010:MapUse(target)
	if target and target:GetUserType() == 2 then --宝宝
		...
		WaitAnswer(2)
		if GetAnswer() == 1 then				
			local NewSkillID = 295
			local NewSkillName = "高级慧根"
...
function Item40010:CanUse(user, target)
end

function Item40010:BattleUse(user, target)

end

AddItemTable(Item40010)