function AIAction0202(battle, mob)
	--狡猾型
	...
	for i = 0, actorCount - 1 do
		...
		if (actor ~= nil and actor:GetTeam() ~= mob:GetTeam() and actor:IsValidTarget() and actor:IsPlayer() and not actor:IsBuffExist(3094)) then
