...
function skill20013CanUse(Atk, skillLv, reqSkillLv, reqCharLv)
...
function skill20013Use(Atk, Target, battle, skillLv)
	...
	local Msg = string.format("\#W[战斗讯息]：魔法不足\#G%d\#W，无法施展巨岩破", consumeSp);
