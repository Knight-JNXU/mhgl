...
function skill19044CanUse(Atk, skillLv, reqSkillLv, reqCharLv)
...
function skill19044Use(Atk, Target, battle, skillLv)
	...
	local Msg = string.format("\#W[战斗讯息]：內力不足\#G%d\#W，无法施展妙手回春", consumeSp);
	...
	while targetlist[i] ~= nil do
		...
		targetlist[i]:ChangeMHp(rec*0.8);
