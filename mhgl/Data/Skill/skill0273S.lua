...
function skill0273CanUse(Atk, skillLv, reqSkillLv, reqCharLv)
end

function skill0273Use(Atk, Target, battle, skillLv)
	...
	if HitRate < 15 and Target:IsBuffExist(1403) ~= true and Target:GetHP() ~= 0 then 
