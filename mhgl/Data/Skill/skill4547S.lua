...
function skill4547CanUse(Atk, skillLv, reqSkillLv, reqCharLv)
	
end

function skill4547Use(Atk, Target, battle, skillLv)
	...
	local Msg = string.format("\#W[战斗讯息]：內力不足\#P%d\#W，无法施展嗜血追击", consumeSp);
