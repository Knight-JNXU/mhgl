...
function skill6234CanUse(Atk, skillLv, reqSkillLv, reqCharLv)
end

function skill6234Use(Atk, Target, battle, skillLv)
	...
	while targetlist[i] ~= nil do
		if targetlist[i]:GetIndex() ~= Atk:GetIndex() then			
			...
			if result == 2 then
				...
				if Atk:GetMob_id() == 30706 then
					if math.random(1, 100) <= 20 and not targetlist[i]:IsBuffExist(1109) then
						targetlist[i]:AddBuff(1109, (Lv + 10), 0, 0, 4, 100);
					end
				end
			end
