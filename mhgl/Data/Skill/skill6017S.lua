...
function skill6017CanUse(Atk, skillLv, reqSkillLv, reqCharLv)
end

function skill6017Use(Atk, Target, battle, skillLv)
	local lianjiRate = 30
	...
	local anti = Target:GetElementAnti(2)
	...
	local hpChange = (Atk:GetElementAttack(2) + 3.2 * lv +  20 ) * per;
