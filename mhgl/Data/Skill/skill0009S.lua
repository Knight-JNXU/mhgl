...
function skill0009CanUse(Atk, skillLv, reqSkillLv, reqCharLv)
...
function skill0009Use(Atk, Target, battle, skillLv)
	local targetlist = {};
	
	local consumeSp = 0.3 *skillLv + 15;
	
	local Msg = string.format("\#W[战斗讯息]：內力不足\#G%d\#W，无法施展风卷流云", consumeSp);
