...
function skill14012CanUse(Atk, skillLv, reqSkillLv, reqCharLv)
...
function skill14012Use(Atk, Target, battle, skillLv)
	...
	local Msg = string.format("\#W[战斗讯息]：內力不足\#G%d\#W，无法施展鹰击", consumeSp);
