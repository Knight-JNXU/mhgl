...
function skill0035CanUse(Atk, skillLv, reqSkillLv, reqCharLv)
...
function skill0035Use(Atk, Target, battle, skillLv)
	local targetlist = {};
	...
	local Msg = string.format("\#W[战斗讯息]：內力不足\#G%d\#W，无法施展飞虹贯日", consumeSp);
