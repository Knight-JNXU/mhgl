...
function skill23061CanUse(Atk, skillLv, reqSkillLv, reqCharLv)
...
function skill23061Use(Atk, Target, battle, skillLv)
	
	if Target:IsBuffExist(1506) then
		Atk:SkillFail("\#W[战斗讯息]：目标已经处在蜜润状态");
		do return end
	end
	...
	local Msg = string.format("\#W[战斗讯息]：內力不足\#G%d\#W，无法施展蜜润", consumeSp);
