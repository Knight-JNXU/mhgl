...
function skill2422CanUse(Atk, skillLv, reqSkillLv, reqCharLv)
...
function skill2422Use(Atk, Target, battle, skillLv)

	local consumeSp = 0.3 * skillLv +10;
	if Atk:IsBuffExist(1702) then
		consumeSp = consumeSp * 2;
	end
	local Msg = string.format("\#W[战斗讯息]：內力不足\#G%d\#W，无法施展七星透骨针", consumeSp);
