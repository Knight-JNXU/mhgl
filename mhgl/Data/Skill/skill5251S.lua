...
function skill5251CanUse(Atk, skillLv, reqSkillLv, reqCharLv)
end

function skill5251Use(Atk, Target, battle, skillLv)
	...
	if lianji == 1 then
		...
		while targetlist[j] ~= nil do
			...
			--if FinalDam > targetlist[j]:GetHP() then
			--	FinalDam = targetlist[j]:GetHP();
			--end
