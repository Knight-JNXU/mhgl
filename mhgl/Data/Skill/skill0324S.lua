...
function skill0324CanUse(Atk, skillLv, reqSkillLv, reqCharLv)
end

function skill0324Use(Atk, Target, battle, skillLv)
	...
	local Msg = string.format("\#W[战斗讯息]：内力不足\#G%d\#W，无法施展河东狮吼", consumeSp);
