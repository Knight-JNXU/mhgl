...
function skill0244CanUse(Atk, skillLv, reqSkillLv, reqCharLv)
...
function skill0244Use(Atk, Target, battle, skillLv)

	local consumeSp = 1.2 * skillLv +10;
	
	local Msg = string.format("\#W[战斗讯息]：內力不足%d，无法施展万蚁噬骨", consumeSp);
