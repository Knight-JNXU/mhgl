...
function skill16014CanUse(Atk, skillLv, reqSkillLv, reqCharLv)
...
function skill16014Use(Atk, Target, battle, skillLv)

	local consumeDp = 150;
	if Atk:IsBuffExist(1702) then
		consumeDp = consumeDp * 2;
	end
	local Msg = string.format("\#W[战斗讯息]：愤怒不足%d，无法施展天诛地灭", consumeDp);
