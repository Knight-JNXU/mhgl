...
function skill15012CanUse(Atk, skillLv, reqSkillLv, reqCharLv)
...
function skill15012Use(Atk, Target, battle, skillLv)
	
	local consumeSp = 40;	
	if Atk:IsBuffExist(1702) then
		consumeSp = consumeSp * 2;
	end
	local Msg = string.format("\#W[战斗讯息]：魔法不足\#G%d\#W，无法施展摄魄", consumeSp);
