...
function skill8029CanUse(Atk, skillLv, reqSkillLv, reqCharLv)
end

function skill8029Use(Atk, Target, battle, skillLv)
	local targetlist = {};
	...
	while targetlist[i] ~= nil do
		NormalDam = (5.2 - 0.3 * count) * Lv + 0.25 * Atk:GetWeaponATK()  + 30;
			...
			local AtkEffect = (1 - 0.15 * Lv / 100) * Target:GetATK();
		
			Target:AddBuff(45, Lv, AtkEffect, 0, turn, 100);
