...
function skill5161CanUse(Atk, skillLv, reqSkillLv, reqCharLv)
end

function skill5161Use(Atk, Target, battle, skillLv)
	...
	if result == 2 then
		...
		Target:AddBuff(1115, (Lv + 10), PowEffect, 0, turn, 100);
	end
	battle:PushReactionActor(Target);
