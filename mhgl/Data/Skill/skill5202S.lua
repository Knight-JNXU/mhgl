...
function skill5202CanUse(Atk, skillLv, reqSkillLv, reqCharLv)
end

function skill5202Use(Atk, Target, battle, skillLv)
	local targetlist = {};
	...
	while targetlist[i] ~= nil do
		...
		targetlist[i]:AddBuff(1201, (Lv + 10), rec1, rec2, turn, 100);
