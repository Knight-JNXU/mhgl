...
function skill14052CanUse(Atk, skillLv, reqSkillLv, reqCharLv)
...
function skill14052Use(Atk, Target, battle, skillLv)
	...
	if Atk:GetSkillLv(394) > 0 then
	    ...
	    DamRate = {0.75, 0.7, 0.65, 0.6, 0.55, 0.5, 0.4};
		AtkNum = 7
		CritRate = Atk:GetSkillLv(394)
		if CritRate < 5 then
		   CritRate = 5
		end	
	end
