...
function skill13031CanUse(Atk, skillLv, reqSkillLv, reqCharLv)
...
function skill13031Use(Atk, Target, battle, skillLv)
	
	local consumeSp = 0.3 * skillLv + 10;
	if Atk:IsBuffExist(1702) then
		consumeSp = consumeSp * 2;
	end
	local Msg = string.format("\#W[战斗讯息]：内力不足\#G%d\#W，无法施展反间计", consumeSp);
