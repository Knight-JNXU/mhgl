...
function skill20014CanUse(Atk, skillLv, reqSkillLv, reqCharLv)
...
function skill20014Use(Atk, Target, battle, skillLv)
	...
	local Msg = string.format("\#W[战斗讯息]：魔法不足\#G%d\#W，无法施展苍茫树", consumeSp);
