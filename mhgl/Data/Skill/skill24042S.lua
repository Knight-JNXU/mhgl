...
function skill24042CanUse(Atk, skillLv, reqSkillLv, reqCharLv)

end

function skill24042Use(Atk, Target, battle, skillLv)
	
	if Target:IsBuffExist(57) then
	...
	while targetlist[i] ~= nil do
		...
		targetlist[i]:AddBuff(57, 1, 0, 0, turn, 100);
