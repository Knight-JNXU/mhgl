...
function skill3242CanUse(Atk, skillLv, reqSkillLv, reqCharLv)
...
function skill3242Use(Atk, Target, battle, skillLv)

	local consumeSp = 0.4 * skillLv + 10;
	if Atk:IsBuffExist(1702) then
		consumeSp = consumeSp * 2;
	end
	local Msg = string.format("\#W[战斗讯息]：內力不足\#G%d\#W，无法施展回天乏力", consumeSp);
