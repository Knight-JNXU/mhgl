...
function skill9782CanUse(Atk, skillLv, reqSkillLv, reqCharLv)
end

function skill9782Use(Atk, Target, battle, skillLv)
	...
	local Msg = string.format("\#W[战斗讯息]：魔法不足\#G%d\#W，无法施展奔雷咒", consumeSp);
