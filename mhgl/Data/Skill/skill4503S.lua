...
function skill4503CanUse(Atk, skillLv, reqSkillLv, reqCharLv)
	
end

function skill4503Use(Atk, Target, battle, skillLv)
	
	local sLv = Atk:GetLevel();
	local targetlist = {};
	local maxTargetCount = math.floor((sLv - 30) / 30) + 2;
	...
	local Msg = string.format("\#W[战斗讯息]：內力不足\#P%d\#W，无法施展怒斩千关", consumeSp);
