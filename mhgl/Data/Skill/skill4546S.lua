...
function skill4546CanUse(Atk, skillLv, reqSkillLv, reqCharLv)
	
end

function skill4546Use(Atk, Target, battle, skillLv)
	
	local sLv = Atk:GetLevel();
	local consumeSp = 1.0 * sLv;
	local Msg = string.format("\#W[战斗讯息]：内力不足\#G%d\#W，无法施展善恶有报", consumeSp);
