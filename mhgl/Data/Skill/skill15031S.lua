...
function skill15031CanUse(Atk, skillLv, reqSkillLv, reqCharLv)
...
function skill15031Use(Atk, Target, battle, skillLv)
	
	local consumeSp = 60;
	if Atk:IsBuffExist(1702) then
		consumeSp = consumeSp * 2;
	end
	local Msg = string.format("\#W[战斗讯息]：魔法不足\#G%d\#W，无法施展复苏", consumeSp);
