...
function skill10061CanUse(Atk, skillLv, reqSkillLv, reqCharLv)
	
	if skillLv < reqSkillLv then 
		local Msg = string.format("\#W[战斗讯息]：此技能需逆鳞\#G%d\#W级以上才能使用", reqSkillLv);
		Atk:SkillFail(Msg);
		do return end
...
function skill10061Use(Atk, Target, battle, skillLv)
	local consumeSp = 40
	...
	Target:AddBuff(50000, skillLv, AttriAtk, 0, 6, 100);
