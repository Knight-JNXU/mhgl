...
function skill64171CanUse(Atk, skillLv, reqSkillLv, reqCharLv)
...
function skill64171Use(Atk, Target, battle, skillLv)
	...
	if Atk:GetHP() < reqHp then
		Atk:SkillFail("\#W[战斗讯息]：生命不足\#G30\%\#W，无法施展风雷七星斩");
		do return end
	end
