...
function skill20011CanUse(Atk, skillLv, reqSkillLv, reqCharLv)
...
function skill20011Use(Atk, Target, battle, skillLv)
	...
	local Msg = string.format("\#W[战斗讯息]：魔法不足\#G%d\#W，无法施展日光华", consumeSp);
	...
	while targetlist[i] ~= nil do
		...
		local FinalDam = (skillLv * 10+100)*3*(1-(count-1)*0.1) +Atk:GetSkillLv(378)*10+weaponDam;
		if skillLv < 120 then
