...
function skill23031CanUse(Atk, skillLv, reqSkillLv, reqCharLv)
...
function skill23031Use(Atk, Target, battle, skillLv)
	...
	if result == 2 then
		...
		Target:AddBuff(1008, skillLv, 0, 0, 100, 100);
	end
