...
function skill3021Use(Atk, Target, battle, skillLv)
	...
	local rec1 = 2.2 * skillLv + 0.1 * skillDam + 0.01 * Target:GetMaxHP() + 0.1 * (Atk:GetPOW() + Atk:GetWeaponATK());
	local rec2 = 1.4 * skillLv + 0.1 * skillDam + 0.05 * (Atk:GetPOW() + Atk:GetWeaponATK());
	if rec1 <= 1 then
		rec1 = 1;
	end
	if rec2 <= 1 then
