...
function skill2202CanUse(Atk, skillLv, reqSkillLv, reqCharLv)
	
	if skillLv < reqSkillLv then 
		local Msg = string.format("\#W[战斗讯息]：此招式需飞纵术修炼到\#G%d\#W级以上才能施展", reqSkillLv);
		Atk:SkillFail(Msg);
		do return end
...
function skill2202Use(Atk, Target, battle, skillLv)
	...
	if Target:GetFaction() == 3 and Target:GetCclass() == 1 then
