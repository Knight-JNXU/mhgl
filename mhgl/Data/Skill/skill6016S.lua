...
function skill6016CanUse(Atk, skillLv, reqSkillLv, reqCharLv)
end

function skill6016Use(Atk, Target, battle, skillLv)
	local lianjiRate = 30
	...
	local anti = Target:GetElementAnti(1)
	...
	local hpChange = (Atk:GetElementAttack(1) + 3.2 * lv +  20 ) * per;
