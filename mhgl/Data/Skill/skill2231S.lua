...
function skill2231CanUse(Atk, skillLv, reqSkillLv, reqCharLv)
...
function skill2231Use(Atk, Target, battle, skillLv)
	--Sp=0.2 * 技能等级 +10
	local consumeSp = 0.4 * skillLv +10;
	if Atk:IsBuffExist(1702) then
		consumeSp = consumeSp * 2;
	end
	local Msg = string.format("\#W[战斗讯息]：內力不足\#G%d\#W，无法施展掷骰解穴", consumeSp);
