...
function skill5221Use(Atk, Target, battle, skillLv)
  ...
  local consumeSp = ((2.8 * Lv + 10) / maxTargetCount) * count;
	...
	while targetlist[i] ~= nil do
		local rec1 = 0.65 * (Lv + 10) + 0.05 * targetlist[i]:GetMaxHP() + 0.05 * Atk:GetPOW();
		local rec2 = 0.65 * (Lv + 10) + 0.05 * targetlist[i]:GetMaxHP() + 0.05 * Atk:GetPOW();
