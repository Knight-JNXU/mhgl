...
function skill6219CanUse(Atk, skillLv, reqSkillLv, reqCharLv)
end

function skill6219Use(Atk, Target, battle, skillLv)
	...
	if math.random(1,100) <= CritRate then
		FinalDam = ((1 * Atk:GetATK() - FinalDef + 250) * wDam - 250) * randomDam * critDam;
		CritHit = 1;
	else
		FinalDam = ((1 * Atk:GetATK() - FinalDef + 250) * wDam - 250) * randomDam;	
	end
