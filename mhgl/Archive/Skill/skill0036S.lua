...
function skill0036CanUse(Atk, skillLv, reqSkillLv, reqCharLv)
...
function skill0036Use(Atk, Target, battle, skillLv)
	local targetlist = {};
	...
	local Msg = string.format("\#W[战斗讯息]：內力不足\#G%d\#W，无法施展枯树开花", consumeSp);
