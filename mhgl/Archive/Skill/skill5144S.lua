...
function skill5144CanUse(Atk, skillLv, reqSkillLv, reqCharLv)
end

function skill5144Use(Atk, Target, battle, skillLv)
	...
	if Atk:IsMob() then
		if Atk:GetMob_id() == 30737 or Atk:GetMob_id() == 30746  then
	...
	if result == 2 then
		...
		Target:AddBuff(1109, (Lv + 10), 0, 0, turn, 100);
	end
	battle:PushReactionActor(Target);
