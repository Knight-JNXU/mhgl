...
function skill5244CanUse(Atk, skillLv, reqSkillLv, reqCharLv)
end

function skill5244Use(Atk, Target, battle, skillLv)
	...
	if HitRate < 25 and Target:IsBuffExist(1404) ~= true and Target:GetHP() ~= 0 then
