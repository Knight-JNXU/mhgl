...
function skill4501CanUse(Atk, skillLv, reqSkillLv, reqCharLv)
	
end

function skill4501Use(Atk, Target, battle, skillLv)
	
	local sLv = Atk:GetLevel();
	local consumeSp = 1.2 * sLv;
	local Msg = string.format("\#W[战斗讯息]：内力不足\#G%d\#W，无法施展一剑飞花", consumeSp);
