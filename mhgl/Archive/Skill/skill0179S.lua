...
function skill0179CanUse(Atk, skillLv, reqSkillLv, reqCharLv)
...
function skill0179Use(Atk, Target, battle, skillLv)

	local consumeSp = 1.2 * skillLv +10;
	
	local Msg = string.format("\#W[战斗讯息]：內力不足%d，无法施展神龙出云", consumeSp);
