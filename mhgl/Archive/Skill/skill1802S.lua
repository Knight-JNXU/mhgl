...
function skill1802CanUse(Atk, skillLv, reqSkillLv, reqCharLv)
...
function skill1802Use(Atk, Target, battle, skillLv)
	...
	if Target:GetFaction() == 4 and Target:GetCclass() == 2 then
