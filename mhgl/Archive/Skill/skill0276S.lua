...
function skill0276CanUse(Atk, skillLv, reqSkillLv, reqCharLv)
end

function skill0276Use(Atk, Target, battle, skillLv)
	...
	local effectPOW = (1 - 0.05) * Target:GetPOW();
	...
	if HitRate < 15 and Target:IsBuffExist(1407) ~= true and Target:GetHP() ~= 0 then
		Target:AddBuff(1407, lv, effectPOW, 0, 3, 100);
	end
