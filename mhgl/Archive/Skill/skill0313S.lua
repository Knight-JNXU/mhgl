...
function skill0313CanUse(Atk, skillLv, reqSkillLv, reqCharLv)
end

function skill0313Use(Atk, Target, battle, skillLv)
	...
	local Msg = string.format("\#W[战斗讯息]：内力不足\#G%d\#W，无法施展骇浪滔天", consumeSp);
