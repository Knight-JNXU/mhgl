...
function skill2833CanUse(Atk, skillLv, reqSkillLv, reqCharLv)
...
function skill2833Use(Atk, Target, battle, skillLv)
	...
	local rec1 = 4.6 * skillLv + 0.5 * skillDam + 0.1 * Target:GetMaxHP() + 0.15 * (Atk:GetPOW() + Atk:GetWeaponATK());
	...
	local rec2 = 2.2 * skillLv + 0.5 * skillDam  + 0.15 * Atk:GetPOW();
	if rec2 <= 1 then
		rec2 = 1;
	end
