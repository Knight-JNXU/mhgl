...
function skill8027CanUse(Atk, skillLv, reqSkillLv, reqCharLv)
end

function skill8027Use(Atk, Target, battle, skillLv)
	local targetlist = {};
	
	local maxTargetCount = math.floor((Lv - 20 )/ 25) + 2;
	...
	while targetlist[i] ~= nil do
		NormalDam = (5.2 - 0.3 * count) * Lv + 0.25 * Atk:GetWeaponATK() + 30;
			...
			local DefEffect = (1 - 0.15 * Lv / 100) * Target:GetDEF();
		
			Target:AddBuff(46, Lv, DefEffect, 0, turn, 100);
