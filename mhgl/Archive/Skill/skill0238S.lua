...
function skill0238CanUse(Atk, skillLv, reqSkillLv, reqCharLv)
...
function skill0238Use(Atk, Target, battle, skillLv)

	local consumeSp = 1.2 * skillLv +10;
	
	local Msg = string.format("\#W[战斗讯息]：內力不足%d，无法施展鹰击长空", consumeSp);
