...
function skill1623Use(Atk, Target, battle, skillLv)
	...
	if math.random(1,100) <= CritRate then
		FinalDam = ((1.35 * Atk:GetATK() - 0.80 * FinalDef + weaponDam + 250) * wDam - 250) * randomDam * critDam;
		CritHit = 1;
	else
		FinalDam = ((1.35 * Atk:GetATK() -  0.80 * FinalDef + weaponDam + 250) * wDam - 250) * randomDam;
	end
