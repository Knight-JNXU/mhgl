...
function skill5243CanUse(Atk, skillLv, reqSkillLv, reqCharLv)
end

function skill5243Use(Atk, Target, battle, skillLv)
	...
	if HitRate < 25 and Target:IsBuffExist(1407) ~= true and Target:GetHP() ~= 0 then
