...
function skill1831CanUse(Atk, skillLv, reqSkillLv, reqCharLv)
...
function skill1831Use(Atk, Target, battle, skillLv)
	--Sp=0.3 * 技能等级 +10
	...
	local Msg = string.format("\#W[战斗讯息]：內力不足\#G%d\#W，无法施展七断七绝掌", consumeSp);
