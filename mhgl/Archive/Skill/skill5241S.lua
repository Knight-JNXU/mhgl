...
function skill5241CanUse(Atk, skillLv, reqSkillLv, reqCharLv)
end

function skill5241Use(Atk, Target, battle, skillLv)
	...
	if HitRate < 25  and Target:IsBuffExist(1406) ~= true and Target:GetHP() ~= 0 then 
