...
function skill0277CanUse(Atk, skillLv, reqSkillLv, reqCharLv)
end

function skill0277Use(Atk, Target, battle, skillLv)
	...
	local effectHIT = (1 - 0.05) * Target:GetHIT();
	local effectEVA = (1 - 0.05) * Target:GetEVA();
	...
	if HitRate < 15 and Target:IsBuffExist(1404) ~= true and Target:GetHP() ~= 0 then
		Target:AddBuff(1404, lv, effectHIT, effectEVA, 3, 100);
	end
