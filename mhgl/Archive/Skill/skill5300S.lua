...
function skill5300Attri(Char, skillLv, Attri) 
	...
	deflevelmodify = 0.5/deflevelmodify;
	powerlevelmodify = 0.5/powerlevelmodify;
	hitlevelmodify = 1.5/hitlevelmodify;
	evalevelmodify = 0.6/evalevelmodify;
