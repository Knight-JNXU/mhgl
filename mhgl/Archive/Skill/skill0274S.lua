...
function skill0274CanUse(Atk, skillLv, reqSkillLv, reqCharLv)
end

function skill0274Use(Atk, Target, battle, skillLv)
	...
	local effectDef = (1 - 0.05) * Target:GetDEF();
	...
	if HitRate < 15  and Target:IsBuffExist(1406) ~= true and Target:GetHP() ~= 0 then 
		Target:AddBuff(1406, lv, effectDef, 0, 3, 100);
	end
