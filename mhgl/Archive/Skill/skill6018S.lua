...
function skill6018CanUse(Atk, skillLv, reqSkillLv, reqCharLv)
end

function skill6018Use(Atk, Target, battle, skillLv)
	local lianjiRate = 30
	...
	local anti = Target:GetElementAnti(3)
	...
	local hpChange = (Atk:GetElementAttack(3) + 3.2 * lv +  20 ) * per;
