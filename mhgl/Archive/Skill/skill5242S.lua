...
function skill5242CanUse(Atk, skillLv, reqSkillLv, reqCharLv)
end

function skill5242Use(Atk, Target, battle, skillLv)
	...
	if HitRate < 25 and Target:IsBuffExist(1405) ~= true and Target:GetHP() ~= 0 then
