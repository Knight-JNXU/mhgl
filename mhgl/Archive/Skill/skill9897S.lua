...
function skill9897CanUse(Atk, skillLv, reqSkillLv, reqCharLv)
	
end

function skill9897Use(Atk, Target, battle, skillLv)
	...
	local Msg = string.format("\#W[战斗讯息]：内力不足\#G%d\#W，无法施展紫煞手", consumeSp);
