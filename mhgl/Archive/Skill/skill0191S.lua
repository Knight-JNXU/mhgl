...
function skill0191CanUse(Atk, skillLv, reqSkillLv, reqCharLv)
...
function skill0191Use(Atk, Target, battle, skillLv)

	local consumeSp = 1.2 * skillLv +10;
	
	local Msg = string.format("\#W[战斗讯息]：內力不足%d，无法施展霸王举鼎", consumeSp);
